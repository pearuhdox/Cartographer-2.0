...
execute store result score $bundle_slot dt.var run data get storage cartographer_charon:player inventory_test[{id:"minecraft:bundle",components:{"minecraft:custom_data":{DeathBundle:1b}}}].Slot
...
clear @s bundle[minecraft:custom_data~{DeathBundle:1b}] 1