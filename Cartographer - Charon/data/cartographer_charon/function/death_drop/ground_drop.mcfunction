summon item ~ ~0.25 ~ {NoGravity:1b,Glowing:1b,Age:-32768,Health:1000,PickupDelay:2,Tags:["ca.drop_convert_bundle","new"],Item:{id:"minecraft:bundle",count:1}}

data modify storage cartographer_charon:ret_bundle bundle set value {}
data modify storage cartographer_charon:ret_bundle bundle set from entity @s item.components.minecraft:custom_data.DeathBundle
