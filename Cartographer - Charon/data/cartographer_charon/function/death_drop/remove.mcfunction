...
execute as @e[type=item,sort=nearest,limit=1,distance=..2,nbt={Item:{id:"minecraft:bundle",components:{"minecraft:custom_data":{DeathBundle:1b}}}}] at @s run function cartographer_charon:death_drop/modify_item
