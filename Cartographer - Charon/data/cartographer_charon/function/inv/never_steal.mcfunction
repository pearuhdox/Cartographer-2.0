...
execute if data storage cartographer_charon:player temp.components.minecraft:enchantments."cartographer_custom_enchantments:passive/soulbound" run scoreboard players set $rand_t dt.var 1
...
execute if score $never_drop_armor charon.gmr matches 1.. if score $slot dt.var matches 100..103 if data storage cartographer_charon:player temp.components.minecraft:enchantments."minecraft:binding_curse" run scoreboard players set $rand_t dt.var 0
