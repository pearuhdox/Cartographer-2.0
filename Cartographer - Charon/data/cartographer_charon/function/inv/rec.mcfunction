...
execute if data storage cartographer_charon:player temp.components.minecraft:custom_data.CustomEnchantments:[{id:"curse_shattering"}] run function cartographer_charon:item_effects/shattering
