...
execute store result score @s void_home.x run data get storage cartographer:player_data main.working_data.CharonHomePos[0]
execute store result score @s void_home.y run data get storage cartographer:player_data main.working_data.CharonHomePos[1]
execute store result score @s void_home.z run data get storage cartographer:player_data main.working_data.CharonHomePos[2]
