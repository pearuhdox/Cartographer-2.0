...
execute at @s if score $custom_statuses ca.installed matches 1.. as @e[type=#bb:hostile,distance=..10.5] at @s run function carto_event:api/create_single_entity_event {event:"custom_statuses/blindness",duration:60,delay:000,parameters:{amount:1.0,tick_command:""},merge_behavior:"custom"}
