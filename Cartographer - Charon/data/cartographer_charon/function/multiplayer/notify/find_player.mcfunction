...
execute if score $uuid_p0 dt.var = $bag_p0 dt.var if score $uuid_p1 dt.var = $bag_p1 dt.var if score $uuid_p2 dt.var = $bag_p2 dt.var if score $uuid_p3 dt.var = $bag_p3 dt.var run function cartographer_charon:multiplayer/notify/do_notify