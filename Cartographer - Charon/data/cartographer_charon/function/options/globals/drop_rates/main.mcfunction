...
tellraw @s [{"text":"---[➤] ","color":"gray","bold":true,"italic":false},{"bold":false,"text":"Drop Rates","color":"gray","italic":false,"hover_event":{"action":"show_text","value":[{"text":"Set the drop rates for items and experience.","color":"#FFF4D9","italic":true}]}}]

tellraw @s [{"text":"------[➤] ","color":"#FFF4D9","bold":true,"italic":false},{"bold":false,"text":"Experience Drop Rate","color":"aqua","italic":false,"hover_event":{"action":"show_text","value":[{"text":"Set the rate at which experience points drop when the player dies. (When set all points are dropped and this many can be recovered.)","color":"#FFF4D9","italic":true}]},"click_event":{"action":"run_command","command":"/function cartographer_charon:options/globals/drop_rates/xp_rate"}}]
tellraw @s [{"text":"------[➤] ","color":"#FFF4D9","bold":true,"italic":false},{"bold":false,"text":"Item Drop Rate Presets","color":"aqua","italic":false,"hover_event":{"action":"show_text","value":[{"text":"Set the drop rate of items via a couple presets. (Values can be set manually via scoreboard instead.)","color":"#FFF4D9","italic":true}]},"click_event":{"action":"run_command","command":"/function cartographer_charon:options/globals/drop_rates/drop_rate_preset"}}]
tellraw @s [{"text":"------[➤] ","color":"#FFF4D9","bold":true,"italic":false},{"bold":false,"text":"Use Difficulty","color":"aqua","italic":false,"hover_event":{"action":"show_text","value":[{"text":"Game difficulty will affect the drop rate of items. (Easy will drop less items. Hard will drop more items.)","color":"#FFF4D9","italic":true}]},"click_event":{"action":"run_command","command":"/function cartographer_charon:options/globals/drop_rates/use_difficulty"}}]
