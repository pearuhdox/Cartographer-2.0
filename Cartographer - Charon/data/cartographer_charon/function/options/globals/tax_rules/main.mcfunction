...
tellraw @s [{"text":"---[➤] ","color":"gray","bold":true,"italic":false},{"bold":false,"text":"Tax Rules","color":"gray","italic":false,"hover_event":{"action":"show_text","value":[{"text":"Set penalties or conditions that affect dropped items.","color":"#FFF4D9","italic":true}]}}]

tellraw @s [{"text":"------[➤] ","color":"#FFF4D9","bold":true,"italic":false},{"bold":false,"text":"Item Count Tax","color":"aqua","italic":false,"hover_event":{"action":"show_text","value":[{"text":"Set the percentage of stack count lost from an item when it is dropped.","color":"#FFF4D9","italic":true}]},"click_event":{"action":"run_command","command":"/function cartographer_charon:options/globals/tax_rules/count"}}]
tellraw @s [{"text":"------[➤] ","color":"#FFF4D9","bold":true,"italic":false},{"bold":false,"text":"Item Durability Tax","color":"aqua","italic":false,"hover_event":{"action":"show_text","value":[{"text":"Set the percentage of remaining durability taken from an item when it is dropped.","color":"#FFF4D9","italic":true}]},"click_event":{"action":"run_command","command":"/function cartographer_charon:options/globals/tax_rules/durability"}}]
tellraw @s [{"text":"------[➤] ","color":"#FFF4D9","bold":true,"italic":false},{"bold":false,"text":"Item Vanishing Tax","color":"aqua","italic":false,"hover_event":{"action":"show_text","value":[{"text":"Set the value at which items have a chance to vanish instead of being dropped.","color":"#FFF4D9","italic":true}]},"click_event":{"action":"run_command","command":"/function cartographer_charon:options/globals/tax_rules/vanish"}}]
tellraw @s [{"text":" ","color":"#FFF4D9","italic":false}]

tellraw @s [{"text":"------[➤] ","color":"#FFF4D9","bold":true,"italic":false},{"bold":false,"text":"Progressive Tax Mode","color":"aqua","italic":false,"hover_event":{"action":"show_text","value":[{"text":"Enable progressive taxes, which increase the tax values as players die, slowly decreasing over time.","color":"#FFF4D9","italic":true}]},"click_event":{"action":"run_command","command":"/function cartographer_charon:options/globals/tax_rules/progressive"}}]
tellraw @s [{"text":" ","color":"#FFF4D9","italic":false}]

tellraw @s [{"text":"------[➤] ","color":"#FFF4D9","bold":true,"italic":false},{"bold":false,"text":"Retain Items for Taxes","color":"aqua","italic":false,"hover_event":{"action":"show_text","value":[{"text":"Enable to retain items that would have normally been dropped (but allows taxes to still apply to said items).","color":"#FFF4D9","italic":true}]},"click_event":{"action":"run_command","command":"/function cartographer_charon:options/globals/tax_rules/retain_items"}}]
