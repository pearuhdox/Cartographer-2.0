...
execute unless score @s ca.charon_statue_cdl matches 1.. as @e[type=interaction,tag=ca.charon_respawnable_interaction,distance=..5] at @s run function cartographer_charon:respawnable/interact/verify_right

advancement revoke @s only cartographer_charon:interact_statue/right