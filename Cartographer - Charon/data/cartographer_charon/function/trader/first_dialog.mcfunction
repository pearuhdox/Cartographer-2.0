...
tellraw @s {"translate":"cartographer.charon.trader.first_dialog.2","fallback":"Charon can be traded with like a villager using %s.","color":"gray","with":[[{"text":"[","color":"white","hoverEvent":{"action":"show_text","contents":[{"text":"","color":"white"}]}},{"keybind":"key.use","color":"aqua","hoverEvent":{"action":"show_text","contents":[{"text":"","color":"white"}]}},{"text":"]","color":"white","hoverEvent":{"action":"show_text","contents":[{"text":"","color":"white"}]}}]]}
