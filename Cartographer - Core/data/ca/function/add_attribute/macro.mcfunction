...
$data modify storage cartographer_core:enchant_item data.item.components.minecraft:attribute_modifiers append value {id:"$(int_uuid)-$(rand_uuid)",type:"$(name)",amount:$(val),operation:"$(op)",slot:"$(slot)"}
