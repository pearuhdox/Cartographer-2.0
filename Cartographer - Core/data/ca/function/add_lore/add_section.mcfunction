...
#Run for Text
execute if score $text_type ca.var matches 1 run function ca:add_lore/add_section/text with storage cartographer_core:loreify data

#Run for Translate
execute if score $text_type ca.var matches 2 run function ca:add_lore/add_section/translate with storage cartographer_core:loreify data

#Run for Keybind
execute if score $text_type ca.var matches 3 run function ca:add_lore/add_section/keybind with storage cartographer_core:loreify data

#Show Dialog At End for Next Section
function ca:add_lore/show_dialog