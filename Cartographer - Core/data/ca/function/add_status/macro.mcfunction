...
$data modify storage cartographer_core:enchant_item data.item.components.minecraft:custom_data.apply_status.$(action).$(affects) append value {id:"$(id)",duration:$(dur),amplifier:$(amp),conditions:{$(conditions)}}
