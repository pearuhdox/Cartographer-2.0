#function ca:add_status {action:"melee_hit",affects:"target",id:"vanilla_effect",effect:"weakness",duration:100,amplifier:1,conditions:""}
...
$data modify storage cartographer_core:custom_status data merge value {effect:"$(effect)"}
...
function ca:add_status/macro_vanilla with storage cartographer_core:custom_status data