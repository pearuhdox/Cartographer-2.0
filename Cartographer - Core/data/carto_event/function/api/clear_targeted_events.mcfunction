#removes all events that are targeting this entity in this tick
## no macro arguments
...
function carto_event:api/zzz/clear_targeted_events with storage carto_event event_clear_macro