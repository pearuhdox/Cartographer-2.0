#removes all events of this id and type that are owned by this entity in this tick
## macro arguments
...
function carto_event:api/zzz/remove_owned_events with storage carto_event event_clear_macro