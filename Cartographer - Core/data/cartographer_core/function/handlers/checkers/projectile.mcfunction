...
execute if entity @s[tag=ca.is_fishing_bobber_tracker,tag=!ca.tagged_entity] as @e[type=#cartographer_core:hostile,dx=0,dy=0,dz=0] positioned ~-0.9 ~-0.9 ~-0.9 if entity @s[dx=0,dy=0,dz=0] run scoreboard players set $bobber_tag ca.registry 1
