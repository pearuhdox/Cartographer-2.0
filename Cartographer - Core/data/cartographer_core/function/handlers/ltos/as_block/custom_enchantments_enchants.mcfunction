...
execute if score @s ca.ench_starfall_hand_lvl matches 1.. run function cartographer_custom_enchantments:enchantment/passive/starfall/break_spawner
execute if score @s ca.ench_orbit_hand_lvl matches 1.. run function cartographer_custom_enchantments:enchantment/passive/orbit/break_spawner
