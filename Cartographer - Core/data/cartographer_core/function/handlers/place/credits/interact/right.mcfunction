...
execute unless score @s ca.charon_statue_cdl matches 1.. as @e[type=interaction,tag=ca.core_credits_block,distance=..5] at @s run function cartographer_core:handlers/place/credits/interact/verify_right

advancement revoke @s only cartographer_core:interact_credits/right