...
execute if score $pt_1 ca.uuid_interact = $pt_v_1 ca.uuid_interact if score $pt_2 ca.uuid_interact = $pt_v_2 ca.uuid_interact if score $pt_3 ca.uuid_interact = $pt_v_3 ca.uuid_interact if score $pt_4 ca.uuid_interact = $pt_v_4 ca.uuid_interact run function cartographer_core:handlers/place/credits/interact/do_left