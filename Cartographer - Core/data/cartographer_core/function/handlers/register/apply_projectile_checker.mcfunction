...
execute unless score $custom_attributes ca.installed matches 1.. if score $custom_statuses ca.installed matches 1.. if entity @s[type=potion,tag=ca.has_attribute_data] on passengers if entity @s[type=marker,tag=ca.new,tag=ca.projectile_checker] run data modify entity @s data.status_data.projectile_hit.radius set value 4.0d
execute unless score $custom_attributes ca.installed matches 1.. if score $custom_enchantments ca.installed matches 1.. if entity @s[type=potion,tag=ca.has_attribute_data] on passengers if entity @s[type=marker,tag=ca.new,tag=ca.projectile_checker] run data modify entity @s data.enchant_data.radius set value 4.0d
