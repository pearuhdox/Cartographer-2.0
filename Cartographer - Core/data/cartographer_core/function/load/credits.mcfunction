...
tellraw @s [{"text":"            ❰ ","color":"gold"},{"text":"Creator & Lead Designer","color":"#CFFFFD","bold":false,"italic":false,"underlined":false},{"text":" ❱ ","color":"gold"}]
tellraw @s [{"text":"                       PearUhDox","color":"#DB2FED","bold":false,"italic":false}]

tellraw @s [{"text":"\n      ❰ ","color":"gold"},{"text":"Cartographer Event Handler Design","color":"#CFFFFD","bold":false,"italic":false,"underlined":false},{"text":" ❱ ","color":"gold"}]
tellraw @s [{"text":"                         Gibbsly","color":"#BF0000","bold":false,"italic":false}]
...
tellraw @s [{"text":"\n         ❰ ","color":"gold"},{"text":"Library Support / Development","color":"#CFFFFD","bold":false,"italic":false,"underlined":false},{"text":" ❱ ","color":"gold"}]
tellraw @s [{"text":"                 RockNRed","color":"#FF004C","bold":false,"italic":false,"hoverEvent":{"action":"show_text","contents":[{"text":"\"I can stop at any time\"","color":"#FFE0A3","italic":true}]}},{"text":" Suso ","color":"#61C0FF","bold":false,"italic":false,"hoverEvent":{"action":"show_text","contents":[{"text":"Technical Debt Collector","color":"#FFE0A3","italic":true}]}},{"text":"Gibbsly","color":"#BF0000","bold":false,"italic":false,"hoverEvent":{"action":"show_text","contents":[{"text":"\"Your feet, hand them over.\"","color":"#FFE0A3","italic":true}]}}]
tellraw @s [{"text":"              Mulv ","color":"#3dddc8","bold":false,"italic":false},{"text":"McTsTs ","color":"#04D621","bold":false,"italic":false},{"text":"CooleyBrekka","color":"#A94DF5","bold":false,"italic":false}]
