...
execute if score $#lib_del ca.installed matches 1 if score $#lib_bs ca.installed matches 1 if score $#lib_ehid ca.installed matches 1 if score $#lib_mot ca.installed matches 1 run scoreboard players set $#lib_all_found ca.installed 1