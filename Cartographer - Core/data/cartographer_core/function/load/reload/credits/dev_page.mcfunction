...
tellraw @p {"text":"-------------------------------------","color":"#FFE0A3","bold":true}
execute if score @s ca.credits_menu matches ..3 run tellraw @p [{"text":"","color":"gray","bold":true,"italic":false},{"text":"[⏎] ","color":"#33FFF8","bold":true,"italic":false,"hoverEvent":{"action":"show_text","contents":[{"text":"Return to the reload panel.","color":"#FFE0A3","italic":true}]},"clickEvent":{"action":"run_command","value":"/function cartographer_core:load/reload_panel"}},{"text":"[»] ","color":"gray","bold":true,"italic":false,"hoverEvent":{"action":"show_text","contents":[{"text":"Currently Viewing Developer Credits","color":"#FFE0A3","italic":true}]}},{"text":"[»] ","color":"#90ffd1","bold":true,"italic":false,"hoverEvent":{"action":"show_text","contents":[{"text":"View Tester Credits","color":"#FFE0A3","italic":true}]},"clickEvent":{"action":"run_command","value":"/trigger ca.credits_menu set 2"}},{"text":"[»] ","color":"#ffb46e","bold":true,"italic":false,"hoverEvent":{"action":"show_text","contents":[{"text":"View Patron Credits","color":"#FFE0A3","italic":true}]},"clickEvent":{"action":"run_command","value":"/trigger ca.credits_menu set 3"}}]
execute unless score @s ca.credits_menu matches ..3 run tellraw @p [{"text":"","color":"gray","bold":true,"italic":false},{"text":"[»] ","color":"gray","bold":true,"italic":false,"hoverEvent":{"action":"show_text","contents":[{"text":"Currently Viewing Developer Credits","color":"#FFE0A3","italic":true}]}},{"text":"[»] ","color":"#90ffd1","bold":true,"italic":false,"hoverEvent":{"action":"show_text","contents":[{"text":"View Tester Credits","color":"#FFE0A3","italic":true}]},"clickEvent":{"action":"run_command","value":"/trigger ca.credits_menu set 5"}},{"text":"[»] ","color":"#ffb46e","bold":true,"italic":false,"hoverEvent":{"action":"show_text","contents":[{"text":"View Patron Credits","color":"#FFE0A3","italic":true}]},"clickEvent":{"action":"run_command","value":"/trigger ca.credits_menu set 6"}}]
tellraw @p {"text":"-------------------------------------","color":"#FFE0A3","bold":true}
