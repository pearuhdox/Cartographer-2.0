...
tellraw @s [{"text":"❱ ","color":"#FFE0A3","hoverEvent":{"action":"show_text","contents":[{"text":"","color":"#FFE0A3"}]}},{"text":"Version: ","color":"#C4FFFF","bold":false},{"text":"December 2024 Beta Release for MC 1.21.4","color":"white","underlined":true}]
