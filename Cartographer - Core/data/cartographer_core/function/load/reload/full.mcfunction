...
tellraw @s [{"text":"[📦]","color":"#C4FFFF","bold":true,"italic":false,"click_event":{"action":"open_url","url":"https://github.com/pearuhdox/Cartographer-2.0"},"hover_event":{"action":"show_text","value":[{"text":"Version: ","color":"#C4FFFF","bold":false},{"text":"October 2025 Release for MC 1.21.5","color":"white","underlined":true},{"text":"\nClick to visit Cartographer's Github!","color":"#FFE0A3","italic":true}]}},{"text":" ","hover_event":{"action":"show_text","value":[{"text":"","color":"#FFE0A3","italic":true}]}},{"text":"[⭐]","color":"#33FFF8","bold":true,"italic":false,"hover_event":{"action":"show_text","value":[{"text":"Click to see who helped bring you Cartographer.","color":"#FFE0A3","italic":true}]},"click_event":{"action":"run_command","command":"/trigger ca.credits_menu set 1"}},{"text":" ","hover_event":{"action":"show_text","value":[{"text":"","color":"#FFE0A3","italic":true}]}},{"text":"[⚙]","color":"#E8E86D","bold":true,"italic":false,"hover_event":{"action":"show_text","value":[{"text":"Click to configure various options in Cartographer.","color":"#FFE0A3","italic":true}]},"click_event":{"action":"run_command","command":"/trigger ca.options_trig set 1"}},{"text":" ","hover_event":{"action":"show_text","value":[{"text":"","color":"#FFE0A3","italic":true}]}},{"text":"[»]","color":"#F04FF0","bold":true,"hover_event":{"action":"show_text","value":[{"text":"Click for detailed information on all installed library packs.","color":"#FFE0A3","italic":true}]},"click_event":{"action":"run_command","command":"/function cartographer_core:load/reload/show_libraries"}},{"text":" ","hover_event":{"action":"show_text","value":[{"text":"","color":"#FFE0A3","italic":true}]}},{"text":"[»]","color":"#21FF6B","bold":true,"hover_event":{"action":"show_text","value":[{"text":"Click for detailed information on all installed content packs.","color":"#FFE0A3","italic":true}]},"click_event":{"action":"run_command","command":"/function cartographer_core:load/reload/show_installed"}}]
