...
tellraw @s [{"text":"❱ ","color":"#FFE0A3","hoverEvent":{"action":"show_text","contents":[{"text":"","color":"#FFE0A3"}]}},{"text":"Version: ","color":"#C4FFFF","bold":false},{"text":"June 2024 Release for MC 1.20.5","color":"white","underlined":true}]
