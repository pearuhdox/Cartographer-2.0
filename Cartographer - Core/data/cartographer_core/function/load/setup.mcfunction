...
scoreboard objectives add ca.xp dummy
...
execute unless score $gl_reload_msg ca.gamerule matches 1.. as @a at @s run playsound minecraft:ui.cartography_table.take_result master @s ~ ~ ~ 1 0.75
