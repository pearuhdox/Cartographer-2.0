...
schedule function cartographer_core:systems/disables/anvil/schedule 2t
summon item_frame ~ ~ ~ {Invulnerable:1b,Invisible:1b,Fixed:1b,Tags:["disabled_anvil_place"]}
