...
data modify storage cartographer_core:quick_drop save set value []
data modify storage cartographer_core:quick_drop rec set value []
data modify storage cartographer_core:quick_drop rec set from entity @s item.components.minecraft:container

function cartographer_core:systems/quick_drop/shulker/rec

data modify block ~ ~ ~ Items set from storage cartographer_core:quick_drop save
