execute if entity @s[tag=ca.attr_slot_feet] run function cartographer_custom_attributes:calculator/mob/get_item_info {slot:"ArmorItems[0]"}
execute if entity @s[tag=ca.attr_slot_legs] run function cartographer_custom_attributes:calculator/mob/get_item_info {slot:"ArmorItems[1]"}
execute if entity @s[tag=ca.attr_slot_body] run function cartographer_custom_attributes:calculator/mob/get_item_info {slot:"ArmorItems[2]"}
execute if entity @s[tag=ca.attr_slot_head] run function cartographer_custom_attributes:calculator/mob/get_item_info {slot:"ArmorItems[3]"}

execute if entity @s[tag=ca.attr_slot_offh] run function cartographer_custom_attributes:calculator/mob/get_item_info {slot:"HandItems[1]"}
execute if entity @s[tag=ca.attr_slot_main] run function cartographer_custom_attributes:calculator/mob/get_item_info {slot:"HandItems[0]"}
