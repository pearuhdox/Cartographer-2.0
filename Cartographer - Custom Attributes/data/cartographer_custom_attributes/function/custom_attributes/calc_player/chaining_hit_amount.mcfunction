...
scoreboard players set @s ca.attr_chaining_hit_amount_value_head 0
scoreboard players set @s ca.attr_chaining_hit_amount_value_chest 0
scoreboard players set @s ca.attr_chaining_hit_amount_value_legs 0
scoreboard players set @s ca.attr_chaining_hit_amount_value_feet 0
scoreboard players set @s ca.attr_chaining_hit_amount_value_saddle 0
scoreboard players set @s ca.attr_chaining_hit_amount_value_body 0
...
scoreboard players set @s ca.attr_chaining_hit_amount_percent_head 0
scoreboard players set @s ca.attr_chaining_hit_amount_percent_chest 0
scoreboard players set @s ca.attr_chaining_hit_amount_percent_legs 0
scoreboard players set @s ca.attr_chaining_hit_amount_percent_feet 0
scoreboard players set @s ca.attr_chaining_hit_amount_percent_saddle 0
scoreboard players set @s ca.attr_chaining_hit_amount_percent_body 0

scoreboard players set @s ca.attr_chaining_hit_amount_percent 0

scoreboard players set $attr ca.attr_var 0
execute store result score $attr ca.attr_var run data get storage cartographer_core:player_equip data.feet.components.minecraft:custom_data.custom_attributes.chaining_hit_amount.value.amount 100
scoreboard players operation @s ca.attr_chaining_hit_amount_value_feet += $attr ca.attr_var

scoreboard players set $attr ca.attr_var 0
execute store result score $attr ca.attr_var run data get storage cartographer_core:player_equip data.legs.components.minecraft:custom_data.custom_attributes.chaining_hit_amount.value.amount 100
scoreboard players operation @s ca.attr_chaining_hit_amount_value_legs += $attr ca.attr_var

scoreboard players set $attr ca.attr_var 0
execute store result score $attr ca.attr_var run data get storage cartographer_core:player_equip data.chest.components.minecraft:custom_data.custom_attributes.chaining_hit_amount.value.amount 100
scoreboard players operation @s ca.attr_chaining_hit_amount_value_chest += $attr ca.attr_var

scoreboard players set $attr ca.attr_var 0
execute store result score $attr ca.attr_var run data get storage cartographer_core:player_equip data.head.components.minecraft:custom_data.custom_attributes.chaining_hit_amount.value.amount 100
scoreboard players operation @s ca.attr_chaining_hit_amount_value_head += $attr ca.attr_var
...
scoreboard players set $attr ca.attr_var 0
execute store result score $attr ca.attr_var run data get storage cartographer_core:player_equip data.body.components.minecraft:custom_data.custom_attributes.chaining_hit_amount.value.amount 100
scoreboard players operation @s ca.attr_chaining_hit_amount_value_body += $attr ca.attr_var

scoreboard players set $attr ca.attr_var 0
execute store result score $attr ca.attr_var run data get storage cartographer_core:player_equip data.saddle.components.minecraft:custom_data.custom_attributes.chaining_hit_amount.value.amount 100
scoreboard players operation @s ca.attr_chaining_hit_amount_value_saddle += $attr ca.attr_var
...
scoreboard players set $attr ca.attr_var 0
execute store result score $attr ca.attr_var run data get storage cartographer_core:player_equip data.feet.components.minecraft:custom_data.custom_attributes.chaining_hit_amount.percent.amount 100
scoreboard players operation @s ca.attr_chaining_hit_amount_percent_feet += $attr ca.attr_var

scoreboard players set $attr ca.attr_var 0
execute store result score $attr ca.attr_var run data get storage cartographer_core:player_equip data.legs.components.minecraft:custom_data.custom_attributes.chaining_hit_amount.percent.amount 100
scoreboard players operation @s ca.attr_chaining_hit_amount_percent_legs += $attr ca.attr_var

scoreboard players set $attr ca.attr_var 0
execute store result score $attr ca.attr_var run data get storage cartographer_core:player_equip data.chest.components.minecraft:custom_data.custom_attributes.chaining_hit_amount.percent.amount 100
scoreboard players operation @s ca.attr_chaining_hit_amount_percent_chest += $attr ca.attr_var

scoreboard players set $attr ca.attr_var 0
execute store result score $attr ca.attr_var run data get storage cartographer_core:player_equip data.head.components.minecraft:custom_data.custom_attributes.chaining_hit_amount.percent.amount 100
scoreboard players operation @s ca.attr_chaining_hit_amount_percent_head += $attr ca.attr_var
...
scoreboard players set $attr ca.attr_var 0
execute store result score $attr ca.attr_var run data get storage cartographer_core:player_equip data.body.components.minecraft:custom_data.custom_attributes.chaining_hit_amount.percent.amount 100
scoreboard players operation @s ca.attr_chaining_hit_amount_percent_body += $attr ca.attr_var

scoreboard players set $attr ca.attr_var 0
execute store result score $attr ca.attr_var run data get storage cartographer_core:player_equip data.saddle.components.minecraft:custom_data.custom_attributes.chaining_hit_amount.percent.amount 100
scoreboard players operation @s ca.attr_chaining_hit_amount_percent_saddle += $attr ca.attr_var
...
tag @s remove ca.do_attr_calc_chaining_hit_amount
