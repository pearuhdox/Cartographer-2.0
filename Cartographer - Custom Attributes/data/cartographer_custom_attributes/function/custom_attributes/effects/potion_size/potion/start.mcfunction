execute on origin if score @s ca.attr_potion_size_value matches -1999999.. run scoreboard players operation $throwable_val ca.attr_aoe_size_value += @s ca.attr_potion_size_value
