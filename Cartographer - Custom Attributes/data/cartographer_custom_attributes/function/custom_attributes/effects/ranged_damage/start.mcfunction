...
execute if entity @s[type=trident] unless score $stop ca.custom_trident matches 1 run function cartographer_custom_attributes:custom_attributes/effects/ranged_damage/trident/start