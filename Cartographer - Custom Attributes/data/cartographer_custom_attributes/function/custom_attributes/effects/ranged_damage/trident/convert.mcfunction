...
$execute as @e[type=$(projectile),limit=1,sort=nearest,tag=ca.custom_trident,tag=ca.new_custom_trident] run function cartographer_custom_attributes:custom_attributes/effects/ranged_damage/trident/convert_branch with storage cartographer_custom_attributes:trident
