...
scoreboard players operation $speed_numer ca.attr_ranged_velocity_total *= $-1 ca.CONSTANT

scoreboard players remove $speed_denom ca.attr_ranged_velocity_total 400
