...
execute unless entity @s[type=potion] run scoreboard players operation $x ca.attr_ranged_velocity_total *= $speed ca.attr_ranged_velocity_total
execute unless entity @s[type=potion] run scoreboard players operation $y ca.attr_ranged_velocity_total *= $speed ca.attr_ranged_velocity_total
execute unless entity @s[type=potion] run scoreboard players operation $z ca.attr_ranged_velocity_total *= $speed ca.attr_ranged_velocity_total

execute if entity @s[type=potion] run scoreboard players operation $x ca.attr_ranged_velocity_total *= $speed ca.attr_ranged_velocity_total
execute if entity @s[type=potion] run scoreboard players operation $y ca.attr_ranged_velocity_total *= $pot_speed ca.attr_ranged_velocity_total
execute if entity @s[type=potion] run scoreboard players operation $z ca.attr_ranged_velocity_total *= $speed ca.attr_ranged_velocity_total
