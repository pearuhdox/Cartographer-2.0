...
$execute if entity @s[type=player] run data modify storage cartographer:custom_attributes attribute_parse set from storage bbl:pldata sudo_root.working_data.cartographer.custom_attributes.$(attribute)
$execute unless entity @s[type=player] run data modify storage cartographer:custom_attributes attribute_parse set from storage amd:mob_data working_data.data.custom_attributes.$(attribute)
