...
$execute if entity @s[type=player] run data modify storage bbl:pldata sudo_root.working_data.cartographer.custom_attributes.$(attribute) set value []
$execute unless entity @s[type=player] run data modify storage amd:mob_data working_data.data.custom_attributes.$(attribute) set value []
