attribute @s minecraft:generic.oxygen_bonus modifier remove ca.attr_chaining_chance_ench_percent
attribute @s minecraft:generic.oxygen_bonus modifier remove ca.attr_chaining_amount_ench_value
