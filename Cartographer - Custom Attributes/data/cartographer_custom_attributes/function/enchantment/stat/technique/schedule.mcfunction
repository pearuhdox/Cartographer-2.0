function cartographer_core:enchant_calculator/full_calculation {namespace:"cartographer_custom_attributes",category:"custom/",enchantment:"technique",type:"passive"}
