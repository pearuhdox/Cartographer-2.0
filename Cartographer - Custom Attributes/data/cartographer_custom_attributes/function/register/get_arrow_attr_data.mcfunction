...
$execute store result score $var_value ca.attr_var run data get entity @s item.components.minecraft:custom_data.custom_attributes.$(attribute).value 100
...
$execute store result score $var_percent ca.attr_var run data get entity @s item.components.minecraft:custom_data.custom_attributes.$(attribute).percent 100
