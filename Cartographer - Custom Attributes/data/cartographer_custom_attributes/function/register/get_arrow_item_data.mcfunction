#aoe size
function cartographer_custom_attributes:register/get_arrow_attr_data {attribute:"aoe_size",base_value:0}
...
#life drain amount
function cartographer_custom_attributes:register/get_arrow_attr_data {attribute:"life_drain_amount",base_value:0}
