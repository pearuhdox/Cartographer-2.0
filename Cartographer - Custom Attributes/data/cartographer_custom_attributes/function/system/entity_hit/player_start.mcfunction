execute if entity @s[advancements={entityid:entity_hurt_player={is_projectile=true,is_lightning=false}}] on attacker run function cartographer_custom_attributes:system/projectile_find/owner_uuid
execute if entity @s[advancements={entityid:entity_hurt_player={is_projectile=true,is_lightning=false}}] at @s run function cartographer_custom_attributes:system/projectile_find/scan
...
execute if entity @s[advancements={entityid:entity_hurt_player={is_projectile=true,is_lightning=false}}] on attacker unless score @s ca.attr_ranged_damage_total matches -1999999.. run scoreboard players set $ranged_damage ca.attr_apply_var 0
...
execute if entity @s[advancements={entityid:entity_hurt_player={is_projectile=false,is_lightning=false}}] if score $do_lucky_hit ca.lucky_hit_var matches 1.. run function cartographer_custom_attributes:custom_attributes/effects/lucky_hit/start {proc_coeff:"100",attack_type:"melee"}
...
execute if entity @s[advancements={entityid:entity_hurt_player={is_projectile=true,is_lightning=false}}] if score $do_lucky_hit ca.lucky_hit_var matches 1.. run function cartographer_custom_attributes:custom_attributes/effects/lucky_hit/start {proc_coeff:"75",attack_type:"projectile"}
