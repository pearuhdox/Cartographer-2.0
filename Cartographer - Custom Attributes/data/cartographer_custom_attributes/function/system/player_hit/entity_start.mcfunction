...
execute if score $do_precise_hit ca.precise_hit_var matches 1 run function cartographer_custom_attributes:custom_attributes/effects/precise_hit/start {proc_coeff:"100",attack_type:"melee"}
execute if score $do_precise_hit ca.precise_hit_var matches 2 run function cartographer_custom_attributes:custom_attributes/effects/precise_hit/start {proc_coeff:"75",attack_type:"projectile"}
execute if score $do_precise_hit ca.precise_hit_var matches 3 run function cartographer_custom_attributes:custom_attributes/effects/precise_hit/start {proc_coeff:"75",attack_type:"projectile_potion"}
