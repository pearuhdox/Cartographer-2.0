...
execute if entity @s[advancements={entityid:player_hurt_entity={is_projectile=true,is_lightning=false}}] run function cartographer_custom_attributes:system/projectile_find/owner_uuid
execute at @s if entity @s[advancements={entityid:player_hurt_entity={is_projectile=true,is_lightning=false}}] at @n[tag=ca.projectile_find_loc] run function cartographer_custom_attributes:system/projectile_find/scan
...
execute if entity @s[advancements={entityid:player_hurt_entity={is_projectile=true,is_lightning=false}}] if score $lucky_hit_chance ca.attr_apply_var matches -1999999.. run scoreboard players set $do_lucky_hit ca.lucky_hit_var 2
...
execute if entity @s[advancements={entityid:player_hurt_entity={is_projectile=true,is_lightning=false}}] if score $chaining_hit_chance ca.attr_apply_var matches -1999999.. run scoreboard players set $do_chaining ca.chaining_hit_var 2
...
execute if entity @s[advancements={entityid:player_hurt_entity={is_projectile=true,is_lightning=false}}] if score $restrike_hit_chance ca.attr_apply_var matches -1999999.. run scoreboard players set $do_restrike ca.restrike_hit_var 2
