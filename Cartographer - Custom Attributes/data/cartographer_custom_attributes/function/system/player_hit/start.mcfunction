...
execute if entity @s[advancements={entityid:player_hurt_entity={is_player_attack=true,is_projectile=false}}] if score $lucky_hit_chance ca.attr_apply_var matches -1999999.. run scoreboard players set $do_lucky_hit ca.lucky_hit_var 1
