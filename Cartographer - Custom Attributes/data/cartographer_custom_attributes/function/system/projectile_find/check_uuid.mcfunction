...
execute if score $success ca.uuid_check matches 1 run tag @s add ca.projectile_target_owned_attributes
execute if score $success ca.uuid_check matches 1 run scoreboard players set $found_proj ca.uuid_check 1