$execute unless score $muted_damage ca.ench_aberration_lvl matches 1.. run damage @s $(damage) cartographer_custom_enchantments:enchant_damage_bypass by @e[tag=ca.aberration_bomb,limit=1,sort=nearest]
