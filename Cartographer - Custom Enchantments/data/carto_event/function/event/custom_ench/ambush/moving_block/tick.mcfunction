...
$execute as $(target) at @s if score duration= carto_event matches 6 positioned $(x) $(y) $(z) run function carto_event:event/custom_ench/ambush/moving/appear_vfx
...
$execute positioned $(x) $(y) $(z) if score duration= carto_event matches 1 run function carto_event:event/custom_ench/ambush/moving/end
