...
$function carto_event:api/create_single_entity_event {event:"custom_ench/ambush/moving",duration:8,delay:1,parameters:{victim:"$(victim)",traveler:"$(traveler)",previous_gamemode:"$(previous_gamemode)",size:3.0},merge_behavior:"merge"}
