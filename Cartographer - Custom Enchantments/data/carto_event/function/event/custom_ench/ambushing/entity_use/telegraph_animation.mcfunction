...
scoreboard players operation $size ca.ench_ambushing_lvl *= $25 ca.CONSTANT

scoreboard players operation $t_size ca.telegraph_data = $size ca.ench_ambushing_lvl
