...
execute positioned ~-0.5 ~-0.5 ~-0.5 as @e[type=#cartographer_core:hostile,dx=0,dy=0,dz=0,limit=1,sort=nearest] at @s run function carto_event:event/custom_ench/ambushing/find_target/found
