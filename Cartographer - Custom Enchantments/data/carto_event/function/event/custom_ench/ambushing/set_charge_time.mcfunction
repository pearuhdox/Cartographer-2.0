...
execute unless score @s ca.ench_ambushing_hand_lvl matches 1.. store result score $time ca.ambushing_time run data get entity @s equipment.offhand.components.minecraft:custom_data.cast_time
