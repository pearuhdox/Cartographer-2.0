...
$execute as $(target) at @s if entity @s[tag=ca.ambushing_charging] if score @s ca.ambushing_time matches 1..20 if entity @s[type=!player] run function carto_event:event/custom_ench/ambushing/charge_vfx_entity
