...
$function carto_event:api/create_single_entity_event {event:"custom_ench/ambushing/moving_block",duration:8,delay:1,parameters:{x:$(x),y:$(y),z:$(z),traveler:"$(traveler)",previous_gamemode:"$(previous_gamemode)",size:3.0},merge_behavior:"merge"}
