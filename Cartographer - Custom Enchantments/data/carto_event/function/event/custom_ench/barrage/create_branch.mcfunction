...
scoreboard players operation @s ca.ench_starfall_hand_lvl = $starfall_hand ca.ench_value
scoreboard players operation @s ca.ench_orbit_hand_lvl = $orbit_hand ca.ench_value
scoreboard players operation @s ca.ench_storm_hand_lvl = $storm_hand ca.ench_value
scoreboard players operation @s ca.ench_induction_hand_lvl = $induction_hand ca.ench_value
scoreboard players operation @s ca.ench_eruption_hand_lvl = $eruption_hand ca.ench_value
scoreboard players operation @s ca.ench_soulfire_hand_lvl = $soulfire_hand ca.ench_value
