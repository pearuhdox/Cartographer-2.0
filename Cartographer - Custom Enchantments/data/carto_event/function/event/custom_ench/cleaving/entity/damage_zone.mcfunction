...
execute as @a[tag=ca.cleaving_hit_1,tag=ca.cleaving_hit_2] at @s run function carto_event:event/custom_ench/cleaving/entity/damage with storage carto_event current[-1].parameters
