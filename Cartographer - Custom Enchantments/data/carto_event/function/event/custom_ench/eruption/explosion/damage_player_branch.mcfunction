$execute unless score $muted_damage ca.ench_eruption_lvl matches 1.. run damage @s $(damage) cartographer_custom_enchantments:enchant_damage_bypass by $(telegraph) by $(owner)
