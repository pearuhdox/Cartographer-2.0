...
data modify storage cartographer_core:telegraphing merge set value {teleport_duration:2,start_interpolation:0,interpolation_duration:3,text_opacity:170,transformation:[0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f]}
