...
scoreboard players operation $force ca.ench_var = @s ca.ench_pounce_lvl
...
execute if entity @s[type=!player] run function carto_event:event/custom_ench/pounce/do_push_mob with storage cartographer:custom_enchantments
execute if entity @s[type=player] run function carto_event:event/custom_ench/pounce/pounce_macro with storage cartographer:custom_enchantments

function carto_event:api/create_single_entity_event {event:"custom_ench/pounce/moving",duration:100,delay:0,parameters:{},merge_behavior:"merge"}
tag @s add ca.is_pounce

execute if entity @s[type=player] if score @s ca.ench_pounce_lvl matches 1.. if predicate cartographer_custom_enchantments:has/pounce/offhand_ready unless predicate cartographer_custom_enchantments:has/pounce/mainhand_ready run function cartographer_custom_enchantments:enchantment/weapon/unique/melee/pounce/unapply_offhand
execute if entity @s[type=player] if score @s ca.ench_pounce_lvl matches 1.. if predicate cartographer_custom_enchantments:has/pounce/mainhand_ready run function cartographer_custom_enchantments:enchantment/weapon/unique/melee/pounce/unapply
