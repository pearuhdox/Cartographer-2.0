...
execute store result score $t_size ca.telegraph_data run scoreboard players get $size ca.quake_max
scoreboard players operation $t_size ca.telegraph_data /= $10 ca.CONSTANT

scoreboard players operation $t_size ca.telegraph_data *= $140 ca.CONSTANT
...
data modify storage cartographer_core:telegraphing merge set value {teleport_duration:2,start_interpolation:0,interpolation_duration:8,text_opacity:170,transformation:[0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f]}
