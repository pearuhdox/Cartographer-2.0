...
$execute as $(target) at @s if score @s ca.quick_strike_active matches 0 if score @s ca.quick_strike_stacks matches 1.. run function carto_event:api/create_single_entity_event {event:"custom_ench/quick_strike/cooldown",duration:601,delay:000,parameters:{},merge_behavior:"none"}
