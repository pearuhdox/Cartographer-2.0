...
execute as @a[tag=ca.slamming_hit_1,tag=ca.slamming_hit_2] at @s run tag @s add ca.indicator_warning
execute as @a[tag=ca.slamming_hit_1,tag=ca.slamming_hit_2] at @s run scoreboard players set @s ca.warning_time 3
