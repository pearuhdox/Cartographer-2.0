execute if entity @s[tag=ca.player_spawned] run particle minecraft:dust_color_transition{from_color:[0.431,1.000,0.753],scale:1.3,to_color:[0.890,1.000,0.929]} ~ ~ ~ 0 0 0 1 1 normal
execute if entity @s[tag=ca.player_spawned] run particle minecraft:soul_fire_flame ~ ~0.25 ~ 0.1 0 0.1 0.02 1 normal

execute unless entity @s[tag=ca.player_spawned] run particle minecraft:dust_color_transition{from_color:[1.000,0.592,0.322],scale:1.3,to_color:[1.000,0.820,0.678]} ~ ~ ~ 0 0 0 1 1 normal
