...
$execute if entity @s[type=player] positioned ^-1 ^ ^ positioned ^$(half_size) ^0.6 ^ run particle minecraft:dust_color_transition{to_color:[1.0,1.0,1.0],from_color:[0.020,0.890,0.659],scale:2.0} ~ ~ ~ 0 0 0 0 1 normal
$execute if entity @s[type=player] positioned ^1 ^ ^ positioned ^-$(half_size) ^1.2 ^ run particle minecraft:dust_color_transition{to_color:[1.0,1.0,1.0],from_color:[0.020,0.890,0.659],scale:2.0} ~ ~ ~ 0 0 0 0 1 normal

$execute unless entity @s[type=player] positioned ^-1 ^ ^ positioned ^$(half_size) ^0.6 ^ run particle minecraft:dust_color_transition{to_color:[1.0,1.0,1.0],from_color:[0.541,0.110,0.110],scale:2.0} ~ ~ ~ 0 0 0 0 1 normal
$execute unless entity @s[type=player] positioned ^1 ^ ^ positioned ^-$(half_size) ^1.2 ^ run particle minecraft:dust_color_transition{to_color:[1.0,1.0,1.0],from_color:[0.541,0.110,0.110],scale:2.0} ~ ~ ~ 0 0 0 0 1 normal