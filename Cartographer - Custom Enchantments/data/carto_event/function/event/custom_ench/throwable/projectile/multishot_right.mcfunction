...
execute positioned ^ ^ ^ facing ^-0.2 ^ ^1 rotated ~ ~ positioned ^ ^ ^ if score $multishot ca.throwable_multishot matches 1.. run function carto_event:event/custom_ench/throwable/projectile/multishot_right