...
scoreboard players operation $concentration ca.ench_value = @s ca.ench_concentration_lvl
...
scoreboard players operation $starfall ca.ench_value = @s ca.ench_starfall_lvl
scoreboard players operation $orbit ca.ench_value = @s ca.ench_orbit_lvl
scoreboard players operation $storm ca.ench_value = @s ca.ench_storm_lvl
scoreboard players operation $induction ca.ench_value = @s ca.ench_induction_lvl
scoreboard players operation $eruption ca.ench_value = @s ca.ench_eruption_lvl
scoreboard players operation $soulfire ca.ench_value = @s ca.ench_soulfire_lvl
scoreboard players operation $quake ca.ench_value = @s ca.ench_quake_lvl
scoreboard players operation $aberration ca.ench_value = @s ca.ench_aberration_lvl
...
scoreboard players operation $barrage ca.ench_value = @s ca.ench_barrage_lvl

scoreboard players operation $loyalty ca.ench_value = @s ca.ench_loyalty_lvl
