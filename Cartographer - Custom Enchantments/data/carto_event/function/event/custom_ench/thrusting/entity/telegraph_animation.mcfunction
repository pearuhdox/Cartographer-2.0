...
scoreboard players set $size ca.ench_thrusting_lvl 40

$execute as $(target) if score @s ca.attr_aoe_size_value matches -1999999.. run scoreboard players operation $size ca.ench_thrusting_lvl += @s ca.attr_aoe_size_value
$execute as $(target) if score @s ca.attr_aoe_size_percent matches -1999999.. run scoreboard players operation $size ca.ench_thrusting_lvl *= @s ca.attr_aoe_size_percent
$execute as $(target) if score @s ca.attr_aoe_size_percent matches -1999999.. run scoreboard players operation $size ca.ench_thrusting_lvl /= $100 ca.CONSTANT

scoreboard players operation $t_size ca.telegraph_data = $size ca.ench_thrusting_lvl
...
data modify storage cartographer_core:telegraphing merge set value {}
data modify storage cartographer_core:telegraphing merge set value {teleport_duration:5,start_interpolation:0,interpolation_duration:15,text_opacity:170,transformation:[20.0000f,0.0000f,0.0000f,-0.3834f,0.0000f,0.0000f,20.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f]}
