...
$execute as $(target) at @s if score @s ca.special_attack_windup matches 1 run attribute @s minecraft:attack_damage modifier add ca.thrusting_damage -100 add_multiplied_total

#Start Telegraph 1 tick delayed
$execute as $(target) if score @s ca.special_attack_windup matches 2 as $(telegraph) at @s run function carto_event:event/custom_ench/thrusting/entity/telegraph_animation with storage carto_event current[-1].parameters

#Slowdown
$execute as $(target) at @s if score $perc ca.special_attack_windup matches 15.. if score $perc_prev ca.special_attack_windup matches ..14 run attribute @s minecraft:movement_speed modifier add ca.thrusting_slow -0.35 add_multiplied_total
...
$execute as $(target) at $(telegraph) if entity @s[nbt={DeathTime:0s}] if score $perc ca.special_attack_windup matches 100.. if score $perc_prev ca.special_attack_windup matches ..99 run function carto_event:event/custom_ench/thrusting/entity/damage_zone with storage carto_event current[-1].parameters
$execute as $(target) at $(telegraph) if entity @s[nbt={DeathTime:0s}] if score $perc ca.special_attack_windup matches 100.. if score $perc_prev ca.special_attack_windup matches ..99 run function carto_event:event/custom_ench/thrusting/entity/vfx/run with storage carto_event current[-1].parameters

$execute as $(target) at $(telegraph) if entity @s[nbt={DeathTime:0s}] if score $perc ca.special_attack_windup matches 100.. if score $perc_prev ca.special_attack_windup matches ..99 run function carto_event:event/custom_ench/thrusting/entity/damage_zone/start with storage carto_event current[-1].parameters

$execute as $(target) at $(telegraph) if entity @s[nbt={DeathTime:0s}] if score $perc ca.special_attack_windup matches 90.. if score $perc_prev ca.special_attack_windup matches ..89 run function carto_event:event/custom_ench/thrusting/entity/vfx/frame_1 with storage carto_event current[-1].parameters
$execute as $(target) at $(telegraph) if entity @s[nbt={DeathTime:0s}] if score $perc ca.special_attack_windup matches 95.. if score $perc_prev ca.special_attack_windup matches ..94 run function carto_event:event/custom_ench/thrusting/entity/vfx/frame_2 with storage carto_event current[-1].parameters
$execute as $(target) at $(telegraph) if entity @s[nbt={DeathTime:0s}] if score $perc ca.special_attack_windup matches 100.. if score $perc_prev ca.special_attack_windup matches ..99 run function carto_event:event/custom_ench/thrusting/entity/vfx/frame_3 with storage carto_event current[-1].parameters



$execute as $(target) at @s if score $perc ca.special_attack_windup matches 100.. run attribute @s minecraft:movement_speed modifier remove ca.thrusting_slow
...
$execute if score $perc ca.special_attack_windup matches ..50 as $(target) at @s on target run tag @s add ca.mob_thrusting_target
$execute if score $perc ca.special_attack_windup matches ..49 as $(target) unless entity @s[type=minecraft:zoglin] as $(telegraph) at $(target) facing entity @p[tag=ca.mob_thrusting_target] feet run tp @s ~ ~ ~ ~ 0
$execute if score $perc ca.special_attack_windup matches ..49 as $(target) if entity @s[type=minecraft:zoglin] as $(telegraph) at $(target) facing entity @p feet run tp @s ~ ~ ~ ~ 0
$execute if score $perc ca.special_attack_windup matches 50.. if score $perc_prev ca.special_attack_windup matches ..49 as $(target) unless entity @s[type=minecraft:zoglin] as $(telegraph) at $(target) facing entity @p[tag=ca.mob_thrusting_target] feet run tp @s ~ ~ ~ ~ ~
$execute if score $perc ca.special_attack_windup matches 50.. if score $perc_prev ca.special_attack_windup matches ..49 as $(target) if entity @s[type=minecraft:zoglin] as $(telegraph) at $(target) facing entity @p feet run tp @s ~ ~ ~ ~ ~
$execute if score $perc ca.special_attack_windup matches ..50 as $(target) at @s run tag @a remove ca.mob_thrusting_target

$execute if score $perc ca.special_attack_windup matches 50.. unless score $perc_prev ca.special_attack_windup matches ..49 as $(telegraph) at @s positioned as $(target) run tp @s ~ ~ ~

$execute if score $perc ca.special_attack_windup matches ..90 as $(telegraph) at @s run function carto_event:event/custom_ench/thrusting/entity/detect_player/start with storage carto_event current[-1].parameters

$execute as $(target) at @s run tag @s add ca.is_thrusting

$execute as $(target) at @s if score @s ca.special_attack_windup = $restore_attack ca.special_attack_windup run attribute @s minecraft:attack_damage modifier remove ca.thrusting_damage

$execute as $(target) at @s if score @s ca.special_attack_windup >= $end ca.special_attack_windup run tag @s remove ca.is_thrusting
