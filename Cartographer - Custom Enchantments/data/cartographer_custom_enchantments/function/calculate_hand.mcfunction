...
scoreboard players operation @s ca.ench_hex_eater_lvl += @s ca.ench_hex_eater_gear_lvl
...
scoreboard players operation @s ca.ench_duelist_lvl += @s ca.ench_duelist_gear_lvl
...
scoreboard players operation @s ca.ench_hunter_lvl += @s ca.ench_hunter_gear_lvl
...
scoreboard players operation @s ca.ench_focus_lvl += @s ca.ench_focus_gear_lvl
...
scoreboard players operation @s ca.ench_first_strike_lvl += @s ca.ench_first_strike_gear_lvl
...
scoreboard players operation @s ca.ench_follow_up_lvl += @s ca.ench_follow_up_gear_lvl
...
scoreboard players operation @s ca.ench_concentration_lvl += @s ca.ench_concentration_gear_lvl
...
scoreboard players operation @s ca.ench_chaotic_lvl += @s ca.ench_chaotic_gear_lvl
...
scoreboard players operation @s ca.ench_rushdown_lvl += @s ca.ench_rushdown_gear_lvl
...
scoreboard players operation @s ca.ench_leverage_lvl += @s ca.ench_leverage_gear_lvl
...
scoreboard players operation @s ca.ench_overcharge_lvl += @s ca.ench_overcharge_gear_lvl
...
scoreboard players operation @s ca.ench_point_blank_lvl += @s ca.ench_point_blank_gear_lvl
...
scoreboard players operation @s ca.ench_sharpshot_lvl += @s ca.ench_sharpshot_gear_lvl
...
scoreboard players operation @s ca.ench_recoil_lvl += @s ca.ench_recoil_gear_lvl
...
scoreboard players operation @s ca.ench_explosive_lvl += @s ca.ench_explosive_gear_lvl
...
scoreboard players operation @s ca.ench_pulling_lvl += @s ca.ench_pulling_gear_lvl
...
scoreboard players operation @s ca.ench_repulsion_lvl += @s ca.ench_repulsion_gear_lvl
...
scoreboard players operation @s ca.ench_cleaving_lvl += @s ca.ench_cleaving_gear_lvl
...
scoreboard players operation @s ca.ench_thrusting_lvl += @s ca.ench_thrusting_gear_lvl
...
scoreboard players operation @s ca.ench_quick_strike_lvl += @s ca.ench_quick_strike_gear_lvl
...
scoreboard players operation @s ca.ench_riposte_lvl += @s ca.ench_riposte_gear_lvl
...
scoreboard players operation @s ca.ench_ambushing_lvl += @s ca.ench_ambushing_gear_lvl
...
scoreboard players operation @s ca.ench_lunging_lvl += @s ca.ench_lunging_gear_lvl
...
scoreboard players operation @s ca.ench_throwable_lvl += @s ca.ench_throwable_gear_lvl
...
scoreboard players operation @s ca.ench_correction_lvl += @s ca.ench_correction_gear_lvl
...
scoreboard players operation @s ca.ench_ricochet_lvl += @s ca.ench_ricochet_gear_lvl
...
scoreboard players operation @s ca.ench_barbed_lvl += @s ca.ench_barbed_gear_lvl
...
scoreboard players operation @s ca.ench_ripper_lvl += @s ca.ench_ripper_gear_lvl
...
scoreboard players operation @s ca.ench_shrapnel_lvl += @s ca.ench_shrapnel_gear_lvl
...
scoreboard players operation @s ca.ench_grappling_lvl += @s ca.ench_grappling_gear_lvl
...
scoreboard players operation @s ca.ench_barrage_lvl += @s ca.ench_barrage_gear_lvl
...
scoreboard players operation @s ca.ench_repeating_lvl += @s ca.ench_repeating_gear_lvl
