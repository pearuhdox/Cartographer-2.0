...
scoreboard players set @s ca.ench_punch_gear_lvl 0


scoreboard players set $ench ca.ench_var 0
execute store result score $ench ca.ench_var run data get storage cartographer_core:player_equip data.offh.components.minecraft:enchantments.levels.minecraft:punch
scoreboard players operation @s ca.ench_punch_gear_lvl += $ench ca.ench_var
...
execute unless score @s ca.ench_punch_hand_lvl matches 1.. run scoreboard players operation @s ca.ench_punch_lvl += @s ca.ench_punch_gear_lvl
