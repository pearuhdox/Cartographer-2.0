...
scoreboard players set @s ca.ench_quick_strike_gear_lvl 0
...
execute unless score @s ca.ench_quick_strike_hand_lvl matches 1.. run scoreboard players operation @s ca.ench_quick_strike_lvl += @s ca.ench_quick_strike_gear_lvl
