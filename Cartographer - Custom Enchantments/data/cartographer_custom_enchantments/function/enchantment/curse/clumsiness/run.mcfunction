...
execute if entity @s[type=player] if predicate cartographer_core:player/sneaking if predicate bb:cant_crit if score @s ca.ench_clumsiness_lvl matches 1.. if entity @s[nbt={OnGround:1b}] run function cartographer_custom_enchantments:enchantment/curse/clumsiness/sneak_check
