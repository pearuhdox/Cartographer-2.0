...
execute unless entity @s[tag=ca.pride_activated] if entity @s[type=player] run playsound minecraft:block.ender_chest.open player @s ~ ~ ~ 0.5 1.8
execute unless entity @s[tag=ca.pride_activated] unless entity @s[type=player] run playsound minecraft:block.ender_chest.open hostile @a[distance=..16] ~ ~ ~ 1 1.8
tag @s add ca.pride_activated