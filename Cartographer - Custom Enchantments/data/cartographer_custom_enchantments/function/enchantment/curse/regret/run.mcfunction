...
execute unless entity @s[type=player] run scoreboard players operation @s ca.ench_regret_main_lvl = $was_main ca.calc_type
execute unless entity @s[type=player] run scoreboard players operation @s ca.ench_regret_offh_lvl = $was_offh ca.calc_type
execute unless entity @s[type=player] run scoreboard players operation @s ca.ench_regret_feet_lvl = $was_feet ca.calc_type
execute unless entity @s[type=player] run scoreboard players operation @s ca.ench_regret_legs_lvl = $was_legs ca.calc_type
execute unless entity @s[type=player] run scoreboard players operation @s ca.ench_regret_chest_lvl = $was_body ca.calc_type
execute unless entity @s[type=player] run scoreboard players operation @s ca.ench_regret_head_lvl = $was_head ca.calc_type
