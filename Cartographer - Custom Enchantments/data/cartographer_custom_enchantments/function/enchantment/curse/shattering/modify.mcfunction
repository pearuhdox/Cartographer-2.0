...
data modify storage cartographer_core:helper get_durability set from entity @s Item
...
execute store result score $shattering_cur ca.ench_var run data get entity @s Item.components.minecraft:damage
...
execute store result entity @s Item.components.minecraft:damage int 1 run scoreboard players get $shattering_max ca.ench_var
