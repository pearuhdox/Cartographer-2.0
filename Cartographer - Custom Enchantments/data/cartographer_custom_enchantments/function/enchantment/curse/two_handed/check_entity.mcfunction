...
execute if score $was_main ca.calc_type matches 1.. run scoreboard players add $count ca.ench_two_handed_lvl 1

execute if score $was_offh ca.calc_type matches 1 run tag @s add ca.two_handed_offh_lock
execute if score $was_offh ca.calc_type matches 2.. run tag @s add ca.two_handed_offh_disable
execute if score $was_offh ca.calc_type matches 1.. run scoreboard players add $count ca.ench_two_handed_lvl 1
