...
execute if score @s ca.ench_two_handed_gear_lvl matches 1 run tag @s add ca.two_handed_offh_lock
execute if score @s ca.ench_two_handed_gear_lvl matches 2.. run tag @s add ca.two_handed_offh_disable
execute if score @s ca.ench_two_handed_gear_lvl matches 1.. run scoreboard players add $count ca.ench_two_handed_lvl 1
