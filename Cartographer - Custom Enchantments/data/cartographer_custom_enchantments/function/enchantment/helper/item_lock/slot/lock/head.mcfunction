...
execute if entity @s[type=player] run data modify storage cartographer_custom_enchantments:item_lock item set from entity @s equipment.head
execute unless entity @s[type=player] run data modify storage cartographer_custom_enchantments:item_lock item set from entity @s equipment.head
...
execute unless entity @s[type=player] run data modify entity @s equipment.head set from storage cartographer_custom_enchantments:item_lock item
