...
execute if score $user_id ca.ench_diversion_lvl matches 1 run function cartographer_custom_enchantments:enchantment/passive/diversion/custom_skin/sequex
