...
execute if entity @s[type=player] if score $attack_type ca.ench_value matches 1 unless predicate bb:cant_crit run scoreboard players operation $dmg ca.inertia_stack *= $150 ca.CONSTANT
execute if entity @s[type=player] if score $attack_type ca.ench_value matches 1 unless predicate bb:cant_crit run scoreboard players operation $dmg ca.inertia_stack /= $100 ca.CONSTANT
