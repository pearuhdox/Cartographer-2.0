...
$damage @s $(damage) cartographer_custom_enchantments:enchant_damage by @n[tag=ca.momentum_owner]

execute unless entity @s[type=player] as @e[type=#bb:hostile,distance=0.1..3] at @s run function cartographer_custom_enchantments:enchantment/passive/momentum/hit/knockback with storage cartographer:custom_enchantments
