execute if entity @s[type=player] if predicate cartographer_core:periodic_tick/5 run function cartographer_custom_enchantments:enchantment/passive/momentum/distance_check
execute unless entity @s[type=player] if predicate cartographer_core:periodic_tick/20 run function cartographer_custom_enchantments:enchantment/passive/momentum/distance_check
