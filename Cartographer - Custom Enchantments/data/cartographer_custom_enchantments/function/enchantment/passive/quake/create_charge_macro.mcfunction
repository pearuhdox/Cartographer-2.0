...
execute if score $is_player ca.ench_quake_lvl matches 1.. run scoreboard players set @s ca.quake_time 4
execute unless score $is_player ca.ench_quake_lvl matches 1.. run scoreboard players set @s ca.quake_time -6

execute at @s run playsound minecraft:entity.warden.sonic_boom player @a[distance=..16] ~ ~ ~ 0.2 1.75
execute at @s run playsound minecraft:entity.zombie.break_wooden_door player @a[distance=..16] ~ ~ ~ 0.2 0.85
