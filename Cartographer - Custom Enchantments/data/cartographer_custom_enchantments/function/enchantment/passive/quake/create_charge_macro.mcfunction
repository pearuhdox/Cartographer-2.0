...
execute at @s run playsound minecraft:entity.warden.sonic_boom player @a[distance=..16] ~ ~ ~ 0.4 1.75
execute at @s run playsound minecraft:entity.zombie.break_wooden_door player @a[distance=..16] ~ ~ ~ 0.4 0.85
