...
scoreboard players operation @s ca.quake_dmg += $result_damage ca.ench_var
...
execute positioned ~ ~1 ~ run function cartographer_custom_enchantments:enchantment/passive/quake/transfer_power_vfx with storage cartographer:custom_enchantments