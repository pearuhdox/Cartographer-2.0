$execute if entity @s[tag=ca.player_spawned] run particle trail{color:[0.729,0.804,1.000],target:[$(x),$(y),$(z)],duration:15} ~ ~ ~ 0.3 0.3 0.3 1 20 normal
$execute unless entity @s[tag=ca.player_spawned] run particle trail{color:[1.000,0.816,0.749],target:[$(x),$(y),$(z)],duration:15} ~ ~ ~ 0.3 0.3 0.3 1 20 normal
...
execute if entity @s[tag=ca.player_spawned] run playsound minecraft:entity.puffer_fish.blow_out player @a ~ ~ ~ 0.5 0.85
execute unless entity @s[tag=ca.player_spawned] run playsound minecraft:entity.puffer_fish.blow_out hostile @a ~ ~ ~ 0.5 0.85