...
data modify storage cartographer_custom_enchantments:reconstruction macro.level set from storage cartographer_custom_enchantments:reconstruction item_check.components.minecraft:enchantments.levels.cartographer_custom_enchantments:passive/reconstruction
