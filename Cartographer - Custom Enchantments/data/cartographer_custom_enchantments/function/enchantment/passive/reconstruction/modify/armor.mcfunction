...
execute if score $reconstruct_slot ca.ench_var matches 102 run loot replace entity @s armor.body 1 mine 4206900 0 4206900 dirt[minecraft:custom_data={drop_contents:1b}]
