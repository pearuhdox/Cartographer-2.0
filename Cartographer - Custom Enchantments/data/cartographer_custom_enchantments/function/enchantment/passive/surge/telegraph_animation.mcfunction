...
scoreboard players set $size ca.ench_surge_lvl 40
...
scoreboard players operation $t_size ca.telegraph_data = $size ca.ench_surge_lvl
...
scoreboard players operation $opacity ca.telegraph_data = @s ca.ench_surge_lvl
...
data modify storage cartographer_core:telegraphing merge set value {teleport_duration:3,start_interpolation:0,interpolation_duration:3,text_opacity:170,transformation:[0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f]}
