...
scoreboard players operation $target ca.rand = @s ca.ench_drilling_lvl
...
execute if score $success ca.rand matches 1.. run function cartographer_custom_enchantments:enchantment/tool/drilling/hit_success
execute if score $success ca.rand matches 1.. run scoreboard players set @s ca.drilling_entropy 0

scoreboard players set @s ca.drilling_cooldown 100
