...
function carto_event:api/create_single_entity_event {event:"custom_ench/lightborn",duration:5,delay:000,parameters:{},merge_behavior:"none"}
function carto_event:api/create_single_entity_event {event:"custom_statuses/vanilla_attribute",duration:3,delay:000,parameters:{type:"minecraft:block_break_speed",tag:"ca.lightborn_block",id:"lightborn_block",value:-100,operation:"add_value",tick_command:""},merge_behavior:"none"}