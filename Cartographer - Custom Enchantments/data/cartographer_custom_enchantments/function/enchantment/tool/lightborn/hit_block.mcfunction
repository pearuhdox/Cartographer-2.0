...
execute as @s at @s anchored eyes positioned ^ ^ ^0.1 if score $active ca.ench_lightborn_lvl matches 1.. run function cartographer_custom_enchantments:enchantment/tool/lightborn/recurse