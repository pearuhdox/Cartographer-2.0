...
execute if entity @s[type=player,tag=ca.core_check_inv] unless score @s ca.core_delay_check matches 1.. store result score @s ca.lightborn_copper_torch run clear @s copper_torch[minecraft:enchantments={}] 0
