...
execute if entity @s[type=player,tag=ca.core_check_inv] unless score @s ca.core_delay_check matches 1.. unless data entity @s SelectedItem.components."minecraft:custom_data".multitool_applied run function cartographer_custom_enchantments:enchantment/tool/multitool/apply
...
execute unless entity @s[type=player] if predicate cartographer_core:periodic_tick/20 run function cartographer_core:enchant_calculator/full_calculation {namespace:"cartographer_custom_enchantments",category:"tool/",enchantment:"multitool",type:"tool"}
...
execute unless entity @s[type=player] if predicate cartographer_core:periodic_tick/20 unless data entity @s SelectedItem.components."minecraft:custom_data".multitool_applied run function cartographer_custom_enchantments:enchantment/tool/multitool/apply
