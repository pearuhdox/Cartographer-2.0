...
execute unless data entity @s SelectedItem.components."minecraft:custom_data".multitool_applied run function cartographer_custom_enchantments:enchantment/tool/multitool/apply