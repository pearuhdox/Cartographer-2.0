...
execute on attacker unless entity @s[tag=ca.focus_active] run function carto_event:api/create_single_entity_event {event:"custom_ench/focus/active",duration:120,delay:001,parameters:{},merge_behavior:"merge"}
