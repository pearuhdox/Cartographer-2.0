...
execute if entity @s[type=!player] run playsound minecraft:entity.armor_stand.break hostile @a ~ ~ ~ 1 0.85
execute if entity @s[type=player] run playsound minecraft:entity.armor_stand.break player @a ~ ~ ~ 0.6 0.85
