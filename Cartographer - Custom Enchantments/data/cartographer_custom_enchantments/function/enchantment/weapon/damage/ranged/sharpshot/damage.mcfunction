...
$execute at $(owner) run damage @s $(damage) cartographer_custom_enchantments:enchant_damage_bypass by $(owner)
...
execute on attacker at @s if entity @s[type=!player] run playsound minecraft:entity.arrow.hit_player hostile @s ~ ~ ~ 1 1.5
execute on attacker at @s if entity @s[type=player] run playsound minecraft:entity.arrow.hit_player player @s ~ ~ ~ 0.6 1.5
