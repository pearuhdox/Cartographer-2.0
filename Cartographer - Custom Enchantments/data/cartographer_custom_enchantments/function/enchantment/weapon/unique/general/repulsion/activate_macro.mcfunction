...
execute if entity @s[type=player] positioned ~ ~0.65 ~ run function cartographer_custom_enchantments:enchantment/weapon/unique/general/repulsion/vfx with storage cartographer:custom_enchantments
