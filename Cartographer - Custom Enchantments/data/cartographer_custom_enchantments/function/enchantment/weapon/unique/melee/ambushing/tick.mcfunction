...
execute unless entity @s[tag=ca.has_custom_status_grounded] unless entity @s[tag=has_custom_status_silenced] unless entity @s[tag=ca.is_ambushing] if predicate cartographer_custom_enchantments:has_ambushing_spawner run tag @s add ca.ambushing_spawner
execute unless entity @s[tag=ca.has_custom_status_grounded] unless entity @s[tag=has_custom_status_silenced] unless entity @s[tag=ca.is_ambushing] if predicate cartographer_custom_enchantments:has_ambushing_return run tag @s add ca.ambushing_return
