...
data modify storage cartographer:custom_enchantments lunging_item set from entity @s SelectedItem
...
data modify storage cartographer:custom_enchantments lunging_item.components.minecraft:custom_data.lunging_state set value 2b
data modify storage cartographer:custom_enchantments lunging_item.components.minecraft:custom_data.lunging_cooldown set value 0

data modify storage cartographer:custom_enchantments lunging_item.components.minecraft:custom_data.allow_offhand set value 1b
