scoreboard players remove $time_current ca.ench_lunging_slot 1
execute unless score $time_current ca.ench_lunging_slot matches 1.. run function cartographer_custom_enchantments:enchantment/weapon/unique/melee/lunging/recharge/activate/refill/start
execute unless score $time_current ca.ench_lunging_slot matches 1.. run scoreboard players set $time_current ca.ench_lunging_slot 0

execute store result storage cartographer_custom_enchantments:lunging items[0].components.minecraft:custom_data.lunging_cooldown int 1 run scoreboard players get $time_current ca.ench_lunging_slot
...
execute store result storage cartographer_custom_enchantments:lunging visual.time int 1 run scoreboard players get $time_current ca.ench_lunging_slot
...
execute if score $slot ca.ench_lunging_slot matches -106 run function cartographer_custom_enchantments:enchantment/weapon/unique/melee/lunging/recharge/activate/return_offhand
execute if score $slot ca.ench_lunging_slot matches 0..8 run function cartographer_custom_enchantments:enchantment/weapon/unique/melee/lunging/recharge/activate/return with storage cartographer_custom_enchantments:lunging macro