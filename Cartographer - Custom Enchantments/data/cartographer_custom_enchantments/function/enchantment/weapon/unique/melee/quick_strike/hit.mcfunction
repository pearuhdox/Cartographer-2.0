...
execute unless score @s ca.quick_strike_active matches 1.. if predicate cartographer_custom_enchantments:has_quick_strike_mainhand_ready run tag @s add ca.quick_strike_processed
execute unless score @s ca.quick_strike_active matches 1.. if predicate cartographer_custom_enchantments:has_quick_strike_mainhand_ready run scoreboard players operation @s ca.quick_strike_stacks = @s ca.ench_quick_strike_lvl
execute unless score @s ca.quick_strike_active matches 1.. if predicate cartographer_custom_enchantments:has_quick_strike_mainhand_ready run playsound minecraft:entity.illusioner.prepare_blindness player @s ~ ~ ~ 0.7 1.4
execute unless score @s ca.quick_strike_active matches 1.. if predicate cartographer_custom_enchantments:has_quick_strike_mainhand_ready run function carto_event:api/create_single_entity_event {event:"custom_ench/quick_strike",duration:601,delay:000,parameters:{},merge_behavior:"merge"}
execute unless score @s ca.quick_strike_active matches 1.. if predicate cartographer_custom_enchantments:has_quick_strike_mainhand_ready run scoreboard players operation $active ca.quick_strike_active = @s ca.ench_quick_strike_lvl
execute unless score @s ca.quick_strike_active matches 1.. if predicate cartographer_custom_enchantments:has_quick_strike_mainhand_ready run scoreboard players operation $active ca.quick_strike_active *= $20 ca.CONSTANT
execute unless score @s ca.quick_strike_active matches 1.. if predicate cartographer_custom_enchantments:has_quick_strike_mainhand_ready run scoreboard players add $active ca.quick_strike_active 20
execute unless score @s ca.quick_strike_active matches 1.. if predicate cartographer_custom_enchantments:has_quick_strike_mainhand_ready run scoreboard players add $active ca.quick_strike_active 1
execute unless score @s ca.quick_strike_active matches 1.. if predicate cartographer_custom_enchantments:has_quick_strike_mainhand_ready run function cartographer_custom_enchantments:enchantment/weapon/unique/melee/quick_strike/hit_start