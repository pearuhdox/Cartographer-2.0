...
execute unless score @s ca.quick_strike_active matches 1.. if predicate cartographer_custom_enchantments:has/quick_strike/mainhand_ready run function carto_event:api/create_single_entity_event {event:"custom_ench/quick_strike",duration:601,delay:000,parameters:{},merge_behavior:"merge"}
