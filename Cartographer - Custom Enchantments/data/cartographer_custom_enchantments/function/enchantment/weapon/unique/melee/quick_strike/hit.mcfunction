...
execute unless score @s ca.quick_strike_active matches 1.. unless score @s ca.quick_strike_cooldown matches 1.. run tag @s add ca.quick_strike_processed
execute unless score @s ca.quick_strike_active matches 1.. unless score @s ca.quick_strike_cooldown matches 1.. run scoreboard players operation @s ca.quick_strike_stacks = @s ca.ench_quick_strike_lvl
execute unless score @s ca.quick_strike_active matches 1.. unless score @s ca.quick_strike_cooldown matches 1.. run playsound minecraft:entity.illusioner.prepare_blindness player @s ~ ~ ~ 0.7 1.4
execute unless score @s ca.quick_strike_active matches 1.. unless score @s ca.quick_strike_cooldown matches 1.. run function carto_event:api/create_single_entity_event {event:"custom_ench/quick_strike",duration:601,delay:000,parameters:{},merge_behavior:"merge"}
execute unless score @s ca.quick_strike_active matches 1.. unless score @s ca.quick_strike_cooldown matches 1.. run scoreboard players operation $active ca.quick_strike_active = @s ca.ench_quick_strike_lvl
execute unless score @s ca.quick_strike_active matches 1.. unless score @s ca.quick_strike_cooldown matches 1.. run scoreboard players operation $active ca.quick_strike_active *= $20 ca.CONSTANT
execute unless score @s ca.quick_strike_active matches 1.. unless score @s ca.quick_strike_cooldown matches 1.. run scoreboard players operation $active ca.quick_strike_active > $100 ca.CONSTANT
execute unless score @s ca.quick_strike_active matches 1.. unless score @s ca.quick_strike_cooldown matches 1.. run scoreboard players add $active ca.quick_strike_active 1
execute unless score @s ca.quick_strike_active matches 1.. unless score @s ca.quick_strike_cooldown matches 1.. run scoreboard players operation @s ca.quick_strike_active = $active ca.quick_strike_active
