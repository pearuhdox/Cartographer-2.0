scoreboard players remove $time_current ca.ench_riposte_slot 1
execute unless score $time_current ca.ench_riposte_slot matches 1.. run function cartographer_custom_enchantments:enchantment/weapon/unique/melee/riposte/recharge/activate/refill/start
execute unless score $time_current ca.ench_riposte_slot matches 1.. run scoreboard players set $time_current ca.ench_riposte_slot 0
...
execute store result storage cartographer_custom_enchantments:riposte visual.time int 1 run scoreboard players get $time_current ca.ench_riposte_slot
