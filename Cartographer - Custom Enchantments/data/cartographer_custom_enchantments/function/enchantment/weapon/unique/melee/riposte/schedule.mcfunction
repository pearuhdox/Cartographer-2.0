...
execute if predicate cartographer_custom_enchantments:has_riposte_offhand unless data entity @s Inventory[{Slot:-106b}].components."minecraft:custom_data".riposte_applied run function cartographer_custom_enchantments:enchantment/weapon/unique/melee/riposte/apply_offhand
execute if predicate cartographer_custom_enchantments:has_riposte_mainhand unless data entity @s SelectedItem.components."minecraft:custom_data".riposte_applied run function cartographer_custom_enchantments:enchantment/weapon/unique/melee/riposte/apply
