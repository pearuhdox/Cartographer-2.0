...
execute if entity @s[type=player] if predicate cartographer_custom_enchantments:has/riposte/offhand unless data entity @s Inventory[{Slot:-106b}].components."minecraft:custom_data".riposte_applied run function cartographer_custom_enchantments:enchantment/weapon/unique/melee/riposte/apply_offhand
