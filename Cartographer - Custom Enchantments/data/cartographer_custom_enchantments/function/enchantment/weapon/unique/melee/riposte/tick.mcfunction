...
execute unless entity @s[tag=ca.has_custom_status_silenced] run function carto_event:api/create_single_entity_event {event:"custom_ench/riposte",duration:5,delay:000,parameters:{},merge_behavior:"merge"}
