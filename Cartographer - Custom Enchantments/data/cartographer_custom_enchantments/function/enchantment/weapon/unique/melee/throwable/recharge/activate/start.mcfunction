...
execute unless data storage cartographer_custom_enchantments:throwable data.item.components.minecraft:custom_data.throwable_name run data modify storage cartographer_custom_enchantments:throwable visual.macro set string storage cartographer_custom_enchantments:throwable data.item.id 10
execute unless data storage cartographer_custom_enchantments:throwable data.item.components.minecraft:custom_data.throwable_name run function cartographer_custom_enchantments:enchantment/weapon/unique/melee/throwable/recharge/activate/visual/set_name with storage cartographer_custom_enchantments:throwable visual

execute unless data storage cartographer_custom_enchantments:throwable data.item.components.minecraft:custom_data.throwable_name if data storage cartographer_custom_enchantments:throwable data.item.components.minecraft:custom_name run data modify storage cartographer_custom_enchantments:throwable visual.name set from storage cartographer_custom_enchantments:throwable data.item.components.minecraft:custom_name
execute unless data storage cartographer_custom_enchantments:throwable data.item.components.minecraft:custom_data.throwable_name if data storage cartographer_custom_enchantments:throwable data.item.components.minecraft:item_name run data modify storage cartographer_custom_enchantments:throwable visual.name set from storage cartographer_custom_enchantments:throwable data.item.components.minecraft:item_name

execute if data storage cartographer_custom_enchantments:throwable data.item.components.minecraft:custom_data.throwable_name run data modify storage cartographer_custom_enchantments:throwable visual.name set from storage cartographer_custom_enchantments:throwable data.item.components.minecraft:custom_data.throwable_name
execute unless data storage cartographer_custom_enchantments:throwable visual.name.italic run data modify storage cartographer_custom_enchantments:throwable visual.name.italic set value 0b
