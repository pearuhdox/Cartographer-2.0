...
execute if predicate cartographer_custom_enchantments:has_throwable_offhand unless data entity @s Inventory[{Slot:-106b}].components."minecraft:custom_data".throwable_applied run function cartographer_custom_enchantments:enchantment/weapon/unique/melee/throwable/apply_offhand
execute if predicate cartographer_custom_enchantments:has_throwable_mainhand unless data entity @s SelectedItem.components."minecraft:custom_data".throwable_applied run function cartographer_custom_enchantments:enchantment/weapon/unique/melee/throwable/apply
...
execute unless entity @s[type=player] unless entity @s[tag=has_custom_status_silenced] unless entity @s[tag=ca.mob_use_throwable] unless score @s ca.throwable_cooldown matches 1.. if predicate cartographer_core:periodic_tick/20 at @s if entity @a[distance=4..16,gamemode=!spectator,gamemode=!creative] run function cartographer_custom_enchantments:enchantment/weapon/unique/melee/throwable/mob_ai with storage cartographer:custom_enchantments
