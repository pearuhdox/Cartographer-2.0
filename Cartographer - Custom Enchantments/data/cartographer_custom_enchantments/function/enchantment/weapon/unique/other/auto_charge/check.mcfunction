...
data modify storage cartographer_custom_enchantments:auto_charge items append from entity @s Inventory[{components:{"minecraft:enchantments":{levels:{"cartographer_custom_enchantments:weapon/unique/other/auto_charge":1}}}}]
