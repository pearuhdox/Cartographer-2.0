...
data modify storage cartographer_custom_enchantments:consumable data.use_cooldown set value {seconds:0.2,cooldown_group:"cartographer_auto_charge"}
...
data modify storage cartographer_custom_enchantments:consumable data.inert_item set value {components:{"minecraft:max_stack_size":1,"minecraft:custom_name":'{"color":"#CEA8FF","fallback":"Inert Item","italic":false,"translate":"carto_translate_wip"}',"minecraft:enchantments":{levels:{"cartographer_custom_enchantments:weapon/unique/other/auto_charge":1}},"minecraft:lore":['" "','{"color":"gray","fallback":"An item that is temporarily","italic":false,"translate":"carto_translate_wip"}','{"color":"gray","fallback":"useless from Auto Charge.","italic":false,"translate":"carto_translate_wip"}']},count:1,id:"minecraft:firework_star"}
