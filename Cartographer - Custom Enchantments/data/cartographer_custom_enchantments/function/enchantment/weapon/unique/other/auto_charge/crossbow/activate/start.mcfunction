...
#Setup Visual
execute unless score $repeating ca.ench_auto_charge_slot matches 1.. run data modify storage cartographer_custom_enchantments:auto_charge visual.name set value '{"fallback":"Crossbow","translate":"item.minecraft.crossbow","color":"aqua","italic":false}'
execute unless score $repeating ca.ench_auto_charge_slot matches 1.. unless data storage cartographer_custom_enchantments:auto_charge data.item.components.minecraft:custom_data.auto_charge_name if data storage cartographer_custom_enchantments:auto_charge items[0].components.minecraft:custom_name run data modify storage cartographer_custom_enchantments:auto_charge visual.name set from storage cartographer_custom_enchantments:auto_charge items[0].components.minecraft:custom_name
...
execute unless score $repeating ca.ench_auto_charge_slot matches 1.. unless data storage cartographer_custom_enchantments:auto_charge data.item.components.minecraft:custom_data.auto_charge_name run data modify storage cartographer_custom_enchantments:auto_charge data.item.components.minecraft:custom_data.auto_charge_name set from storage cartographer_custom_enchantments:auto_charge visual.name
