...
execute store result score $infinity_lvl ca.ench_repeating_lvl run data get storage bbl:pldata sudo_root.working_data.cartographer.enchants.repeating.returned_item.components.minecraft:enchantments.levels.minecraft:infinity

execute if score $infinity_lvl ca.ench_repeating_lvl matches 1.. run data modify storage bbl:pldata sudo_root.working_data.cartographer.enchants.repeating.returned_item.components.minecraft:charged_projectiles[-1].components.minecraft:intangible_projectile set value {}
