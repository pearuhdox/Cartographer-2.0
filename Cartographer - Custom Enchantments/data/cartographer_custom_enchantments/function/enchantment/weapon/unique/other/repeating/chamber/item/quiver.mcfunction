...
execute store result score $infinity_lvl ca.ench_repeating_lvl run data get storage cartographer_custom_enchantments:repeating return_item.components.minecraft:enchantments.levels.minecraft:infinity
