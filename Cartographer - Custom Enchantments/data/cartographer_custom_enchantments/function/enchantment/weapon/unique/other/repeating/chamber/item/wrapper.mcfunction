...
execute if entity @s[tag=ca.ench_repeating_offh] run data modify storage cartographer_custom_enchantments:repeating return_item set from entity @s Inventory[{Slot:-106b}] 
