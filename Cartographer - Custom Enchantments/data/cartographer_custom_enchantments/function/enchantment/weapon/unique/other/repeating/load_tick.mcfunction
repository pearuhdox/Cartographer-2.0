...
execute if entity @s[tag=ca.repeating_reloading_offh] store result score $loaded ca.ench_repeating_lvl run data get entity @s Inventory[{Slot:-106b}].components.minecraft:charged_projectiles[0].count
