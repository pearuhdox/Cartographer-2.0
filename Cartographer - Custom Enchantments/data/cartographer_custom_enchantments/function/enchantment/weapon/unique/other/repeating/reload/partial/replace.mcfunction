...
execute if data storage cartographer_custom_enchantments:repeating data.item.components.minecraft:item_name run data modify storage cartographer_custom_enchantments:repeating visual.name set from storage cartographer_custom_enchantments:repeating data.item.components.minecraft:item_name
...
execute unless data storage cartographer_custom_enchantments:repeating visual.name.italic run data modify storage cartographer_custom_enchantments:repeating visual.name.italic set value 0b
