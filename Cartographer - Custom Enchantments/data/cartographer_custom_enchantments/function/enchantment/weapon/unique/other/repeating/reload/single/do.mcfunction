...
execute if entity @s[tag=ca.new_repeating_instance] run data modify storage bbl:pldata sudo_root.working_data.cartographer.enchants.repeating.returned_item set value {}
