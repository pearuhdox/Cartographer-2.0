...
execute unless score $has_infinity ca.ench_repeating_lvl matches 1.. store result storage bbl:pldata sudo_root.working_data.cartographer.enchants.repeating.arrows[0].count int 1 run scoreboard players remove $arrow_ct ca.ench_repeating_lvl 1
execute if score $has_infinity ca.ench_repeating_lvl matches 1.. if data storage bbl:pldata sudo_root.working_data.cartographer.enchants.repeating.arrows[0] store result storage bbl:pldata sudo_root.working_data.cartographer.enchants.repeating.arrows[0].count int 1 run scoreboard players remove $arrow_ct ca.ench_repeating_lvl 1
...
execute store result storage bbl:pldata sudo_root.working_data.cartographer.enchants.repeating.returned_item.components.minecraft:custom_data.repeating_ammo int 1 run scoreboard players add @s ca.repeating_current_ammo 1
