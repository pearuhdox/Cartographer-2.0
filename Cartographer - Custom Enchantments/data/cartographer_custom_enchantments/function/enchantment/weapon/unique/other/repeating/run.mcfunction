...
execute if entity @s[type=player] if score @s ca.ench_repeating_hand_lvl matches 1.. run scoreboard players set $was_main ca.calc_type 1
execute if entity @s[type=player] unless score $was_main ca.calc_type matches 1.. if score @s ca.ench_repeating_gear_lvl matches 1.. run scoreboard players set $was_offh ca.calc_type 1
