data modify storage cartographer_custom_enchantments:scavenger consumable set value {}
data modify storage cartographer_custom_enchantments:scavenger consumable set from storage cartographer_custom_enchantments:scavenger items[0].components.minecraft:use_remainder
data remove storage cartographer_custom_enchantments:scavenger consumable.components.minecraft:use_cooldown
data remove storage cartographer_custom_enchantments:scavenger consumable.components.minecraft:use_remainder
data modify storage cartographer_custom_enchantments:scavenger consumable.components.minecraft:custom_data.use_count set value 0



data modify storage cartographer_custom_enchantments:consumable data set value {}
data modify storage cartographer_custom_enchantments:consumable data.item set from storage cartographer_custom_enchantments:scavenger consumable
...
data modify storage cartographer_custom_enchantments:consumable data.use_remainder_next set from storage cartographer_custom_enchantments:scavenger consumable

#Setup Inert Item Object For Use Remainder
data modify storage cartographer_custom_enchantments:consumable data.inert_item set value {components:{"minecraft:custom_name":{"color":"#CEA8FF","fallback":"Inert Item","italic":false,"translate":"cartographer.item.inert"},"minecraft:enchantments":{"cartographer_custom_enchantments:weapon/unique/other/scavenger":1},"minecraft:lore":[" ",{"color":"gray","fallback":"An item that is temporarily","italic":false,"translate":"cartographer.item.inert.desc.1"},{"color":"gray","fallback":"useless from an enchantment.","italic":false,"translate":"cartographer.item.inert.desc.2"}]},count:1,id:"minecraft:firework_star"}
...
data modify storage cartographer_custom_enchantments:scavenger items[0] set value {}
data modify storage cartographer_custom_enchantments:scavenger items[0] set from storage cartographer_custom_enchantments:consumable data.item
