...
data modify storage cartographer_custom_enchantments:scavenger consumable set from storage cartographer_custom_enchantments:scavenger items[0]
...
scoreboard players add $current_use_count ca.ench_scavenger_slot 1
execute store result storage cartographer_custom_enchantments:scavenger consumable.components.minecraft:custom_data.use_count int 1 run scoreboard players get $current_use_count ca.ench_scavenger_slot
...
scoreboard players remove $use_reload_per ca.ench_scavenger_slot 1