execute if score $current_ammo_amount ca.ench_scavenger_slot matches 1 run function cartographer_custom_enchantments:enchantment/weapon/unique/other/scavenger/crossbow/activate/refill/repeating/chamber
...
execute store result score $max_ammo ca.ench_scavenger_slot run data get storage cartographer_custom_enchantments:scavenger items[0].components.minecraft:enchantments.levels.cartographer_custom_enchantments:weapon/unique/other/repeating
execute store result storage cartographer_custom_enchantments:repeating visual.max int 1 run scoreboard players add $max_ammo ca.ench_scavenger_slot 1
function cartographer_custom_enchantments:enchantment/weapon/unique/other/repeating/visual/get_name
data modify storage cartographer_custom_enchantments:scavenger items[0].components.minecraft:custom_name set from storage cartographer_custom_enchantments:repeating visual.return
