...
execute unless score $repeating ca.ench_scavenger_slot matches 1.. unless data storage cartographer_custom_enchantments:scavenger visual.name.italic run data modify storage cartographer_custom_enchantments:scavenger visual.name.italic set value 0b
