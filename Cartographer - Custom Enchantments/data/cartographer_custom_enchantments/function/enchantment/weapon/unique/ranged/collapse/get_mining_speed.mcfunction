execute on origin store result score $player_mining_speed ca.collapse_break_speed run attribute @s block_break_speed get 10
execute on origin store result score $player_efficiency ca.collapse_break_speed run attribute @s mining_efficiency get 100
