execute store result score $efficiency ca.collapse_break_speed run data get entity @s item.components."minecraft:enchantments".levels.minecraft:efficiency
