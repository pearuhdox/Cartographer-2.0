...
$execute as $(owner) at @s run function carto_event:api/create_single_entity_event {event:"custom_ench/grappling",duration:60,delay:000,parameters:{},merge_behavior:"none"}