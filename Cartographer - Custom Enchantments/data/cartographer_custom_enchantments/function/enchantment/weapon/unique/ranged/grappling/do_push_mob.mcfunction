...
$execute as $(owner) at @s run scoreboard players set @s ca.grappling_cooldown 40
$execute as $(owner) at @s run function carto_event:api/create_single_entity_event {event:"custom_ench/grappling",duration:10,delay:000,parameters:{},merge_behavior:"none"}