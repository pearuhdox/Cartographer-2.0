...
execute if score $levels ca.ench_shrapnel_lvl matches 1.. rotated ~-15 0 run function cartographer_custom_enchantments:enchantment/weapon/unique/ranged/shrapnel/repeat_paths_neg