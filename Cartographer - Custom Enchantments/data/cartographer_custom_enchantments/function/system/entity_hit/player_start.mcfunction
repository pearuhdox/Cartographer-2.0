...
execute if score $attack_type ca.ench_value matches 1 on attacker run function cartographer_custom_enchantments:enchantment/helper/weapon/get_hand_ench_values
