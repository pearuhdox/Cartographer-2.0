...
execute if score $attack_type ca.ench_value matches 1 if score @s ca.ench_cleaving_lvl matches 1.. unless predicate cartographer_core:player/sprinting if predicate bb:cant_crit unless score @s ca.special_attack_cooldown matches 1.. run function cartographer_custom_enchantments:enchantment/weapon/unique/melee/cleaving/hit
...
execute if score $attack_type ca.ench_value matches 1 if score @s ca.ench_thrusting_lvl matches 1.. if predicate cartographer_core:player/sprinting if predicate bb:cant_crit unless score @s ca.special_attack_cooldown matches 1.. run function cartographer_custom_enchantments:enchantment/weapon/unique/melee/thrusting/hit
