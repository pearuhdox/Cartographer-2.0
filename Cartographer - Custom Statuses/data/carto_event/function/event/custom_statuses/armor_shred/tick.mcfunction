...
$execute as $(target) at @s run attribute @s minecraft:armor modifier remove ca.armor_shred
$execute as $(target) at @s if score duration= carto_event matches 2.. run attribute @s minecraft:armor modifier add ca.armor_shred -$(amount) add_multiplied_total
