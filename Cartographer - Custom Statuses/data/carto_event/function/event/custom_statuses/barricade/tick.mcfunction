...
$execute as $(target) at @s if score duration= carto_event matches 2.. unless entity @s[tag=ca.is_parrying] unless entity @s[tag=ca.has_custom_status_nullify] unless entity @s[tag=ca.has_custom_status_nullify_ench] if entity @s[nbt={HurtTime:9s}] run function carto_event:event/custom_statuses/barricade/remove_shield
$execute as $(target) at @s if score duration= carto_event matches 2.. unless entity @s[tag=ca.is_parrying] if entity @s[tag=ca.has_custom_status_nullify] if score @s ca.nullify_cooldown matches 1.. if entity @s[nbt={HurtTime:9s}] run function carto_event:event/custom_statuses/barricade/remove_shield
$execute as $(target) at @s if score duration= carto_event matches 2.. unless entity @s[tag=ca.is_parrying] if entity @s[tag=ca.has_custom_status_nullify_ench] if score @s ca.nullify_cooldown matches 1.. if entity @s[nbt={HurtTime:9s}] run function carto_event:event/custom_statuses/barricade/remove_shield
