execute store result score $effect_old_percentage ca.merge_var run data get storage carto_event old.parameters.amount 100
execute store result score $effect_new_percentage ca.merge_var run data get storage carto_event new.parameters.amount 100
