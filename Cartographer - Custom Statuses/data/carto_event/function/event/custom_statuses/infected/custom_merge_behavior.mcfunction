...
execute store result score $effect_old_death_damage ca.merge_var run data get storage carto_event old.parameters.death_damage 1
execute store result score $effect_new_death_damage ca.merge_var run data get storage carto_event new.parameters.death_damage 1
...
execute if score $effect_new_death_damage ca.merge_var < $effect_old_death_damage ca.merge_var run data modify storage carto_event new.parameters.death_damage set from storage carto_event old.parameters.death_damage
