...
execute store result score $effect_old_wildfire_range ca.merge_var run data get storage carto_event old.parameters.wildfire_range 100
execute store result score $effect_new_wildfire_range ca.merge_var run data get storage carto_event new.parameters.wildfire_range 100

execute store result score $effect_old_wildfire_targets ca.merge_var run data get storage carto_event old.parameters.wildfire_targets 100
execute store result score $effect_new_wildfire_targets ca.merge_var run data get storage carto_event new.parameters.wildfire_targets 100

execute store result score $effect_old_wildfire_duration ca.merge_var run data get storage carto_event old.parameters.wildfire_duration 100
execute store result score $effect_new_wildfire_duration ca.merge_var run data get storage carto_event new.parameters.wildfire_duration 100
