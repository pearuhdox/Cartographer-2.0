execute store result score $aoe_size ca.evocation_var run data get storage carto_event current[-1].parameters.range 100

scoreboard players operation $aoe_size ca.evocation_var += @s ca.attr_aoe_size_value
