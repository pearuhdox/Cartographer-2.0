...
scoreboard players operation $damage ca.warding_var = @s ca.resistor_queue
...
scoreboard players operation @s ca.resistor_queue = $damage ca.warding_var
...
execute if entity @s[type=player] run playsound minecraft:entity.breeze.deflect player @a[distance=..16] ~ ~ ~ 0.75 1.25
