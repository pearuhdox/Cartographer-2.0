...
$execute as $(target) at @s if score duration= carto_event matches 1 run function carto_event:api/create_single_entity_event {event:"status_passive",duration:17,delay:003,parameters:{},merge_behavior:"none"}
