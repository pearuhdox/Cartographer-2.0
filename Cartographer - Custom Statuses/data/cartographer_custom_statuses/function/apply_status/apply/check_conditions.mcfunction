...
$execute as $(owner) at @s run function cartographer_custom_statuses:apply_status/apply/check_conditions/owner_conditions with storage cartographer:custom_statuses
