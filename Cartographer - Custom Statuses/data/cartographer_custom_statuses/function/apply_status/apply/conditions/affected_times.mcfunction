...
$execute store result score $affected_times_current ca.apply_status_conditions run data get storage amd:mob_data working_data.data.affected_data.$(id)_$(action)_$(type)_affected_times_$(affected_times)_id_$(affected_id)
...
$execute store result storage amd:mob_data working_data.data.affected_data.$(id)_$(action)_$(type)_affected_times_$(affected_times)_id_$(affected_id) int 1 run scoreboard players get $affected_times_current ca.apply_status_conditions
