...
execute if score $success ca.rand matches 1.. run scoreboard players operation $chance_entropy ca.apply_status_conditions += $chance_entropy_val ca.apply_status_conditions

execute unless score $success ca.rand matches 1.. run scoreboard players set $chance_entropy ca.apply_status_conditions 0
