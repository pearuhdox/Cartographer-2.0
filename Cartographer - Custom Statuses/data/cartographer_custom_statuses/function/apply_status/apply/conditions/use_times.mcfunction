...
$execute store result score $use_times_current ca.apply_status_conditions run data get storage cartographer:player_data main.working_data.cartographer.status_condition_data.$(id)_$(action)_$(type)_use_times_$(use_times)_id_$(use_id)
...
$execute store result storage cartographer:player_data main.working_data.cartographer.status_condition_data.$(id)_$(action)_$(type)_use_times_$(use_times)_id_$(use_id) int 1 run scoreboard players get $use_times_current ca.apply_status_conditions
