...
$function carto_event:api/create_single_entity_event {event:"lingering_potion/aec_event",duration:600,delay:010,parameters:{radius:$(radius)},merge_behavior:"none"}