...
scoreboard players operation $amplifier ca.apply_status_data *= $25 ca.CONSTANT
...
function cartographer_custom_statuses:apply_status/apply/effect/armor_buff/branch with storage cartographer:custom_statuses apply[0]
