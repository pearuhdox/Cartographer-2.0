...
execute if entity @s[type=player] run data modify storage cartographer:custom_statuses conditional_data set from storage bbl:pldata sudo_root.working_data.cartographer.status_condition_data
...
execute if entity @s[type=player] run data modify storage bbl:pldata sudo_root.working_data.cartographer.status_condition_data set from storage cartographer:custom_statuses conditional_data
...
$execute if entity @s[type=potion] run tag @s add ca.apply_status_potion_throw_$(type)