...
execute unless score $no_triggers ehid_damage_type matches 1 run scoreboard players set $direct_hit ca.apply_status_check 1

execute if score $melee ehid_damage_type matches 1 on attacker if entity @s[tag=ca.apply_status_melee_hit_self] run scoreboard players set $melee_hit_self ca.apply_status_check 1
execute if score $melee ehid_damage_type matches 1 on attacker if entity @s[tag=ca.apply_status_melee_hit_target] run scoreboard players set $melee_hit_target ca.apply_status_check 1
...
execute if score $projectile ehid_damage_type matches 1 on attacker if entity @s[tag=ca.apply_status_ranged_hit_self] run scoreboard players set $ranged_hit_self ca.apply_status_check 1
execute if score $projectile ehid_damage_type matches 1 on attacker if entity @s[tag=ca.apply_status_ranged_hit_target] run scoreboard players set $ranged_hit_self ca.apply_status_check 1
