...
execute if entity @s[type=player] run data modify storage bbl:pldata sudo_root.working_data.cartographer.apply_status_data.actions.ambushing set value {self:[],target:[]}
...
execute if entity @s[type=player] run data modify storage cartographer:custom_statuses calculator.fetch append from storage bbl:pldata sudo_root.working_data.cartographer.apply_status_data.equips[].ambushing.self
...
execute if entity @s[type=player] run data modify storage bbl:pldata sudo_root.working_data.cartographer.apply_status_data.actions.ambushing.self set from storage cartographer:custom_statuses calculator.unpacked
...
data modify storage cartographer:custom_statuses calculator.fetch set value []
data modify storage cartographer:custom_statuses calculator.unpacked set value []
execute if entity @s[type=player] run data modify storage cartographer:custom_statuses calculator.fetch append from storage bbl:pldata sudo_root.working_data.cartographer.apply_status_data.equips[].ambushing.target
...
function cartographer_custom_statuses:calculator/process/unpack/start
execute if entity @s[type=player] run data modify storage bbl:pldata sudo_root.working_data.cartographer.apply_status_data.actions.ambushing.target set from storage cartographer:custom_statuses calculator.unpacked
...
execute if entity @s[type=player] if data storage bbl:pldata sudo_root.working_data.cartographer.apply_status_data.actions.ambushing.self[0] run tag @s add ca.apply_status_ambushing_self
execute if entity @s[type=player] if data storage bbl:pldata sudo_root.working_data.cartographer.apply_status_data.actions.ambushing.target[0] run tag @s add ca.apply_status_ambushing_target
