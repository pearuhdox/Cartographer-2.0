...
execute if entity @s[type=player] run data modify storage bbl:pldata sudo_root.working_data.cartographer.apply_status_data.actions.riposte set value {self:[],target:[]}
...
execute if entity @s[type=player] run data modify storage cartographer:custom_statuses calculator.fetch append from storage bbl:pldata sudo_root.working_data.cartographer.apply_status_data.equips[].riposte.self
...
execute if entity @s[type=player] run data modify storage bbl:pldata sudo_root.working_data.cartographer.apply_status_data.actions.riposte.self set from storage cartographer:custom_statuses calculator.unpacked
...
data modify storage cartographer:custom_statuses calculator.fetch set value []
data modify storage cartographer:custom_statuses calculator.unpacked set value []
execute if entity @s[type=player] run data modify storage cartographer:custom_statuses calculator.fetch append from storage bbl:pldata sudo_root.working_data.cartographer.apply_status_data.equips[].riposte.target
...
function cartographer_custom_statuses:calculator/process/unpack/start
execute if entity @s[type=player] run data modify storage bbl:pldata sudo_root.working_data.cartographer.apply_status_data.actions.riposte.target set from storage cartographer:custom_statuses calculator.unpacked
...
execute if entity @s[type=player] if data storage bbl:pldata sudo_root.working_data.cartographer.apply_status_data.actions.riposte.self[0] run tag @s add ca.apply_status_riposte_self
execute if entity @s[type=player] if data storage bbl:pldata sudo_root.working_data.cartographer.apply_status_data.actions.riposte.target[0] run tag @s add ca.apply_status_riposte_target
