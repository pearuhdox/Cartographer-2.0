...
execute unless entity @s[type=player] if score $has_abs ca.shielding_time matches 1.. run playsound minecraft:entity.creaking.sway hostile @a[distance=..16] ~ ~ ~ 1.2 1.25
execute if entity @s[type=player] if score $has_abs ca.shielding_time matches 1.. run playsound minecraft:entity.creaking.sway player @s ~ ~ ~ 1 1.25
