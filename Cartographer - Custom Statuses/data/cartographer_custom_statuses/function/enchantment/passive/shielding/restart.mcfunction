...
execute unless entity @s[type=player] anchored eyes positioned ^ ^ ^ run function cartographer_core:handlers/text_popup/create {text:"[{\"color\":\"#E5C863\",\"italic\":false,\"translate\":\"cartographer.popup.enchant_effect\",\"fallback\":\"Enchant Effect\"},{\"text\":\"\n\"},{\"color\":\"#2ce0cc\",\"italic\":false,\"translate\":\"enchantment.cartographer.shielding\",\"fallback\":\"Shielding\"}]",popup_duration:25,teleport_duration:2,scale:0.5,background:16777215,text_opacity:150,teleport_position:"~ ~0.35 ~"}
