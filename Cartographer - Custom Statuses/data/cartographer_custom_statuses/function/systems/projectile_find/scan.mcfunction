execute as @e[type=#bb:projectile,nbt=!{inGround:1b}] at @s run function cartographer_custom_statuses:systems/projectile_find/check_uuid with storage cartographer:custom_statuses
