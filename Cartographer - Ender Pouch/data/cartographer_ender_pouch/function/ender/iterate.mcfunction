...
execute unless data storage cartographer:ender_pouch item.components.minecraft:custom_data.no_ender_pouch run function cartographer_ender_pouch:ender/success
