...
execute if score $did_ender_release ca.pouch_var matches 1.. run tellraw @s {"translate":"cartographer.ender_pouch.release","fallback":"Ender Pouch storage has been released!","color":"green","italic":false}