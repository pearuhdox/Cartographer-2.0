...
$execute store result score $ench_dodgeroll ca.lexica_var run data get storage cartographer:lexica item.components.minecraft:bundle_contents[0].components.$(enchant_path).cartographer_custom_enchantments:weapon/unique/ranged/dodgeroll
