...
execute store result score $ench_ambush ca.lexica_var run data get storage cartographer:lexica item.components.minecraft:bundle_contents[0].components.minecraft:stored_enchantments.cartographer_custom_enchantments:weapon/unique/melee/ambush
...
execute store result score $ench_pounce ca.lexica_var run data get storage cartographer:lexica item.components.minecraft:bundle_contents[0].components.minecraft:stored_enchantments.cartographer_custom_enchantments:weapon/unique/melee/pounce
