...
execute if score $timer ca.ticks_frozen matches 1.. run gamerule freeze_damage false
execute if score $timer ca.ticks_frozen matches 1 run gamerule freeze_damage true
execute if score $timer ca.ticks_frozen matches 1.. run scoreboard players remove $timer ca.ticks_frozen 1
execute store result score $gamerule ca.ticks_frozen run gamerule freeze_damage
