...
execute store result score @s ca.dolphins_dur run data get storage cartographer_mob_utils:effects active_effects[{id:"minecraft:dolphins_grace"}].duration 0.05
