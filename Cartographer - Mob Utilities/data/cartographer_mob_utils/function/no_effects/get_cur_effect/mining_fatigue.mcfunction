...
execute store result score @s ca.mining_fatigue_dur run data get storage cartographer_mob_utils:effects active_effects[{id:"minecraft:mining_fatigue"}].duration 0.05
execute store result score @s ca.mining_fatigue_amp run data get storage cartographer_mob_utils:effects active_effects[{id:"minecraft:mining_fatigue"}].ampllfier