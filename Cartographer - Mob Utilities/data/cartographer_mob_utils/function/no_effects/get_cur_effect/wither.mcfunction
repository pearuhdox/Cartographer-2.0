...
execute store result score @s ca.wither_dur run data get storage cartographer_mob_utils:effects active_effects[{id:"minecraft:wither"}].duration 0.05
execute store result score @s ca.wither_amp run data get storage cartographer_mob_utils:effects active_effects[{id:"minecraft:wither"}].ampllfier