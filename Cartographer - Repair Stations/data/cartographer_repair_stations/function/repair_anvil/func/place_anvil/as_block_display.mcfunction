...
summon interaction ~.5 ~-.025 ~.5 {width:1.05f,height:1.05f,Tags:["no_tick","ca.registered","ca.repair_anvil.object","ca.repair_anvil_int.anvil","ca.repair_anvil_int"]}