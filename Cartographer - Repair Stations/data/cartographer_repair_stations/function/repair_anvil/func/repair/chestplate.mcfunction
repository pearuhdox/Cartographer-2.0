...
execute if data entity @p[advancements={cartographer_repair_stations:repair_anvil/right_click=true}] equipment.chest.components.minecraft:damage store result score $item_damage ca.repair_anvil_master run data get entity @p[advancements={cartographer_repair_stations:repair_anvil/right_click=true}] equipment.chest.components.minecraft:damage
execute if data entity @p[advancements={cartographer_repair_stations:repair_anvil/right_click=true}] equipment.chest.components.minecraft:damage store result score $repair_cost ca.repair_anvil_master run data get entity @p[advancements={cartographer_repair_stations:repair_anvil/right_click=true}] equipment.chest.components.minecraft:repair_cost
execute if data entity @p[advancements={cartographer_repair_stations:repair_anvil/right_click=true}] equipment.chest.components.minecraft:damage store result score $lapis_cost ca.repair_anvil_master run data get entity @p[advancements={cartographer_repair_stations:repair_anvil/right_click=true}] equipment.chest.components.minecraft:custom_data.LapisCost
