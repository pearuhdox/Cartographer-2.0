...
execute if score $use_essence ca.repair_station_state matches 1.. store result score $player_lapis ca.repair_station_state run clear @s minecraft:player_head[custom_name='{"color":"dark_aqua","italic":false,"text":"Mob Essence"}'] 0
...
execute if score $scute ca.repair_station_state matches 1.. run data modify storage bbl:vanilla_clear sudo_root.item_id set value "minecraft:turtle_scute"
execute if score $a_scute ca.repair_station_state matches 1.. run data modify storage bbl:vanilla_clear sudo_root.item_id set value "minecraft:armadillo_scute"
...
execute if score $a_scute ca.repair_station_state matches 1.. run scoreboard players operation $mat_cost ca.repair_station_state = $a_scute ca.repair_station_state 
