...
execute unless score $wooden ca.repair_station_state matches 1.. if score $a_scute ca.repair_station_state matches 1.. run data modify storage bbl:vanilla_clear sudo_root.item_id set value "minecraft:armadillo_scute"
