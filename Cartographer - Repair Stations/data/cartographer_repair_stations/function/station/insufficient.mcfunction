data modify entity 31182015-1851-6191-8192-000000000010 text set value {"translate":"cartographer.repair_station.repair.insufficient","fallback":"Not enough resources to repair!","color":"red","bold":true,"italic":false}
