...
data modify entity 31182015-1851-6191-8192-000000000010 text set value {"translate":"cartographer.repair_station.upgrade.free_repair.proc","fallback":"! -= Free Repair =- !","color":"yellow","bold":true,"italic":false,"hover_event":{"action":"show_text","value":[{"text":"","italic":false}]}}
