...
data modify entity 31182015-1851-6191-8192-000000000010 text set value '{"text":"+1 Repairing Rune","color":"#9AFF17","bold":true,"italic":false,"hoverEvent":{"action":"show_text","contents":[{"text":"","italic":false}]}}'
