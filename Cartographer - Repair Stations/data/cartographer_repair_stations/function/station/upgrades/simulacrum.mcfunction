...
data modify entity 31182015-1851-6191-8192-000000000010 text set value '{"translate":"cartographer.repair_station.upgrade.add","fallback":"+1 %s","color":"#9AFF17","bold":true,"italic":false,"with":[{"translate":"cartographer.repair_station.upgrade.simulacrum.name","fallback":"Sulfur Simulacrum"}],"hoverEvent":{"action":"show_text","contents":[{"text":"","italic":false}]}}'
