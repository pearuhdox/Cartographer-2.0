...
execute if score $maces_use_breeze_rods ca.repair_station_state matches 1.. if data storage cartographer_repair_stations:tesseract Data.Current{id:"minecraft:mace"} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:breeze_rod",count:2}
execute unless score $maces_use_breeze_rods ca.repair_station_state matches 1.. if data storage cartographer_repair_stations:tesseract Data.Current{id:"minecraft:mace"} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:quartz",count:2}
...
execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"wooden"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:oak_planks",count:2}
execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"stone"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:cobblestone",count:2}
execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"golden"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:gold_ingot",count:2}
execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"iron"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:iron_ingot",count:2}
execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"diamond"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:diamond",count:2}
execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"netherite"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:netherite_ingot",count:2}
execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"leather"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:leather",count:2}
execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"chain"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:chain",count:2}
execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"turtle_scute"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:turtle_scute",count:2}
execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"armadillo_scute"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:armadillo_scute",count:2}
execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"membrane"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:phantom_membrane",count:2}
execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"string"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:string",count:2}
execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"quartz"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:quartz",count:2}
execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"redstone"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:redstone",count:2}
execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"amethyst"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:amethyst_shard",count:2}
execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"copper"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:copper_ingot",count:2}
execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"emerald"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:carrot",count:2}
execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"carrot"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:warped_fungus",count:2}
execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"warped"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:carrot",count:2}
execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"prismarine"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:prismarine_shard",count:2}
execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"breeze_rod"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:breeze_rod",count:2}

execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"ink"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:ink_sac",count:2}
execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"ender"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:ender_pearl",count:2}
execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"gunpowder"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:gunpowder",count:2}
execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"glowstone"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:glowstone_dust",count:2}
execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"blaze_powder"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:blaze_powder",count:2}
execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"blaze_rod"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:blaze_rod",count:2}

execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"slime"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:slime_ball",count:2}
execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"magma"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:magma_cream",count:2}
execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"star"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:nether_star",count:2}
execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"echo"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:echo_shard",count:2}
execute if data storage cartographer_repair_stations:tesseract Data.Current.components.minecraft:custom_data:{custom_repair:{material:"shulker"}} run data modify entity @s Offers.Recipes[-1].buy set value {id:"minecraft:shulker_shell",count:2}
