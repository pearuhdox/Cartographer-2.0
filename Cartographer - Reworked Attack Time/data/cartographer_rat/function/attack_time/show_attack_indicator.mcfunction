...
execute if score @s ca.rat_perc matches 50..59 run title @s subtitle {"atlas":"minecraft:gui","color":"#7a7a7a","italic":false,"shadow_color":197379,"sprite":"hud/crosshair_attack_indicator_full"}
execute if score @s ca.rat_perc matches 60..69 run title @s subtitle {"atlas":"minecraft:gui","color":"#8a8a8a","italic":false,"shadow_color":197379,"sprite":"hud/crosshair_attack_indicator_full"}
execute if score @s ca.rat_perc matches 70..79 run title @s subtitle {"atlas":"minecraft:gui","color":"#a7a7a7","italic":false,"shadow_color":197379,"sprite":"hud/crosshair_attack_indicator_full"}
execute if score @s ca.rat_perc matches 80..89 run title @s subtitle {"atlas":"minecraft:gui","color":"#bebebe","italic":false,"shadow_color":197379,"sprite":"hud/crosshair_attack_indicator_full"}
execute if score @s ca.rat_perc matches 90..99 run title @s subtitle {"atlas":"minecraft:gui","color":"#d8d8d8","italic":false,"shadow_color":197379,"sprite":"hud/crosshair_attack_indicator_full"}
