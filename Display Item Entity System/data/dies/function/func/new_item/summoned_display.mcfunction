...
data merge entity @s {item_display:"fixed",Tags:["no_tick","ca.registered","dies.object","dies.item_display","dies.target"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,1f,1f]},item:{id:"minecraft:wooden_sword",Count:1b}}
...
execute if score @s dies.object.frame_facing matches 0 run summon interaction ~ ~ ~ {response:1b,width:0.95f,height:-0.3,Tags:["no_tick","ca.registered","dies.object","dies.target","dies.display_interaction","dies.interaction"]}
execute if score @s dies.object.frame_facing matches 1 run summon interaction ~ ~ ~ {response:1b,width:0.95f,height:0.3,Tags:["no_tick","ca.registered","dies.object","dies.target","dies.display_interaction","dies.interaction"]}
execute if score @s dies.object.frame_facing matches 2..5 run summon interaction ~ ~ ~ {response:1b,width:0.95f,height:0.95f,Tags:["no_tick","ca.registered","dies.object","dies.target","dies.display_interaction","dies.interaction"]}
