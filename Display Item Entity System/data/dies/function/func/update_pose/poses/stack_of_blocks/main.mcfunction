...
summon item_display ~ ~ ~ {item_display:"fixed",Tags:["no_tick","ca.registered","dies.object","dies.item_display","dies.target","dies.aux_display","dies.aux_display.1"],transformation:[0.545f,0f,0f,-0.15f,0f,0.545f,0f,0.413f,0f,0f,0.545f,-0.1f,0f,0f,0f,1f],item:{id:"minecraft:dirt",Count:1b}}
summon item_display ~ ~ ~ {item_display:"fixed",Tags:["no_tick","ca.registered","dies.object","dies.item_display","dies.target2","dies.aux_display","dies.aux_display.2"],transformation:[0.545f,0f,0f,-0.3f,0f,0.545f,0f,0.14f,0f,0f,0.545f,-0.2f,0f,0f,0f,1f],item:{id:"minecraft:dirt",Count:1b}}
