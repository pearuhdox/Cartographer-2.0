...
summon item_display ~ ~ ~ {item_display:"fixed",Tags:["no_tick","ca.registered","dies.object","dies.item_display","dies.target","dies.aux_display","dies.aux_display.1"],transformation:[-0.1736481776669303f,-0.984807753012208f,0f,0f,0.984807753012208f,-0.1736481776669303f,0f,0f,0f,0f,1f,-0.089f,0f,0f,0f,1f],item:{id:"minecraft:dirt",Count:1b}}
summon item_display ~ ~ ~ {item_display:"fixed",Tags:["no_tick","ca.registered","dies.object","dies.item_display","dies.target2","dies.aux_display","dies.aux_display.2"],transformation:[0.5735764363510462f,0.8191520442889918f,0f,0f,-0.8191520442889918f,0.5735764363510462f,0f,0f,0f,0f,1f,-0.149f,0f,0f,0f,1f],item:{id:"minecraft:dirt",Count:1b}}
