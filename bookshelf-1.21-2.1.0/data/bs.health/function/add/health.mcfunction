...
execute store success score #success bs.data run attribute @s minecraft:max_health modifier value get bs.health:limit
execute if score #success bs.data matches 1 store result score #health.points bs.data run attribute @s minecraft:max_health get 100000
...
execute store result score #health.max bs.data run attribute @s minecraft:max_health get 100000
execute store result score #health.mod bs.data run attribute @s minecraft:max_health modifier value get bs.health:limit 100000
